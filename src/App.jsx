...
function PartnerCompatibilityResult({ reading, userName, partnerName, activeTab, setActiveTab }) {
  ...
  return (
    <div style={{paddingTop:8,paddingBottom:80,animation:"fadeIn 0.4s ease both"}}>

      {/* Tabs */}
      <div style={{display:"flex",marginBottom:24,gap:6}}>
        {tabs.map(([id,icon,label])=>(
          <button key={id} onClick={()=>setActiveTab(id)}
            style={{flex:1,padding:"10px 4px",background:activeTab===id?`${C.gold}22`:"rgba(201,168,76,0.06)",
              border:`1px solid ${activeTab===id?C.gold:"rgba(201,168,76,0.25)"}`,borderRadius:10,
              color:activeTab===id?C.gold:C.muted,fontFamily:"Cinzel,serif",fontSize:10,
            ...
            */}
            ...
            <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12,gap:6}}>
              {!partnerPhase&&[["extras","🃏","Today's Fortune"],["reading","💖","Partner Compatibility"],["lines","💎","Full Revelation"]].map(([id,icon,label])=>(
                <button key={id} onClick={()=>setActiveTab(id)} className="result-tab"

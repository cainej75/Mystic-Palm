                ...
                {!paid&&!subscribed&&(
                  <div style={{animation:"fadeIn 0.3s"}}>
                    ...
                    <div style={{background:`rgba(42, 138, 122, 0.15)`,border:`1px solid ${C.teal}44`,borderRadius:12,padding:"14px",marginBottom:20}}>
                      ...
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:15,color:C.cream,margin:"0 0 8px",lineHeight:1.7}}>Your compatibility score and insights evolve each month as the cosmic energies influencing your relationship shift and transform.</p>
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:14,color:C.goldDim,margin:0,lineHeight:1.6}}>Each month brings a new reading. As the stars realign with each lunar cycle, you'll discover fresh insights into your ever-deepening connection.</p>
                    </div>

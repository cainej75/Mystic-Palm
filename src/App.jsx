                ...
                {showPartnerDetailsPage&&!partnerPaid?(
                  ...
                  <div style={{animation:"fadeIn 0.3s"}}>
                    ...
                    <div style={{textAlign:"center",marginBottom:24}}>
                      ...
                      <h2 style={{fontFamily:"Cinzel,serif",fontSize:22,color:C.gold,margin:"0 0 12px",letterSpacing:1,cursor:"pointer",userSelect:"none"}} onClick={()=>{devPartnerTapRef.current=(devPartnerTapRef.current||0)+1;clearTimeout(devPartnerTimerRef.current);if(devPartnerTapRef.current>=3){devPartnerTapRef.current=0;setPartnerPaid(true);setShowPartnerDetailsPage(true);}else{devPartnerTimerRef.current=setTimeout(()=>{devPartnerTapRef.current=0;},1200);}}}>Partner Compatibility Reading</h2>

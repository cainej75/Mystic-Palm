...
- Make ALL sections RICH and DETAILED (2-3 sentences minimum per section)
- Each section should reference the larger pattern
- The greeting should weave together hints of all the palm lines
- The fullReading should integrate all sections into one narrative (3-4 paragraphs)
- Keep the tone mystical and authoritative
...
1. greeting (2-3 sentences): Weave together hints about the palm lines and what they reveal
2. lifeLine (3-4 sentences): Their life path and resilience
3. heartLine (3-4 sentences): Emotional patterns and capacity for love
4. headLine (3-4 sentences): Intellectual patterns and thinking style
5. fateLine (3-4 sentences): Direction and threshold approaching
6. fullReading (3-4 paragraphs): Weave lines together into one cohesive narrative
7. nearFuture (2-3 sentences): Specific 30-90 day prediction

The reading to enhance:
${JSON.stringify(reading, null, 2)}

Respond ONLY with valid JSON (no markdown, no preamble, no extra text - ONLY the JSON object): {"greeting":"2-3 sentences weaving palm lines","teaser":"immediate hook about their life right now","lifeLine":"3-4 sentences","heartLine":"3-4 sentences","headLine":"3-4 sentences","fateLine":"3-4 sentences","fullReading":"3-4 paragraphs that integrate all sections","luckyNumber":"1-9","luckyColor":"color name","soulSign":"mystical archetype 2-4 words","warning":"important caution, 2-3 sentences","gift":"hidden strength, 2-3 sentences","pastLife":"vivid past life detail, 1-2 sentences","nearFuture":"2-3 sentences about specific 30-90 day prediction"}`;

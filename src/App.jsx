...
function PartnerCompatibilityResult({ reading, userName, partnerName, onBack }) {
  return (
    <div style={{position:"fixed",inset:0,zIndex:9999,background:"purple",display:"flex",alignItems:"center",justifyContent:"center",flexDirection:"column",gap:20}}>
      <div style={{color:"white",fontSize:32,fontFamily:"sans-serif"}}>PARTNER RESULT</div>
      <div style={{color:"white",fontSize:18}}>Score: {reading?.score}%</div>
      <div style={{color:"white",fontSize:16}}>User: {userName}</div>
      <div style={{color:"white",fontSize:16}}>Partner: {partnerName}</div>
      <button onClick={onBack} style={{padding:"12px 24px",fontSize:16,background:"white",border:"none",borderRadius:8,cursor:"pointer"}}>Back</button>
    </div>
  );
}

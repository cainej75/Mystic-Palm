            ...
            {activeTab==="reading"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:10,position:"relative",overflow:"hidden"}}>
                  ...
                  <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:C.gold,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>{`✦ Reading for ${userName||"You"} ✦`}</div>
                  <TeaserText/>
                </div>
                ...
                {reading.nearFuture&&(
                  <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:11,padding:"12px 13px",marginBottom:10}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.goldDim,letterSpacing:2,textTransform:"uppercase",marginBottom:4,color:C.gold}}>🌟 The Next 90 Days</div>

        ...
        {phase==="result"&&reading&&(
          <div style={{paddingTop:28,paddingBottom:80,animation:"fadeUp 0.6s ease both"}}>
            ...
            <div style={{textAlign:"center",margin:"10px 0 14px"}}>
              ...
              {userName&&birthDate&&(()=>{const s=generateSeed(userName,birthDate);const f=generateFortune(s,userName,birthDate);return(<div style={{fontFamily:"Cinzel,serif",fontSize:13,color:C.muted,letterSpacing:2,textTransform:"uppercase",marginTop:6}}>Life Path {(s%9)+1} · {f.soulSign}</div>);})()}
            </div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:12}}>
              {[["🌙",reading.soulSign,"Soul Sign"],["🔢",reading.luckyNumber,"Lucky #"],["🎨",reading.luckyColor,"Colour"]].map(([ic,v,l])=>(
                <div key={l} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:10,padding:"10px 7px",textAlign:"center"}}>
                  ...
                  <div style={{fontFamily:"IM Fell English,serif",fontSize:16,color:C.cream,lineHeight:1.3}}>{v}</div>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.muted,letterSpacing:1,marginTop:2}}>{l}</div>
                </div>
              ))}
            </div>
            <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12}}>
              {[["reading","📖 Reading"],["lines","✋ Lines"],["extras","🌟 More"]].map(([id,label])=>(
                <button key={id} onClick={()=>setActiveTab(id)}
                  style={{flex:1,background:"none",border:"none",borderBottom:`2px solid ${activeTab===id?C.gold:"transparent"}`,color:activeTab===id?C.gold:C.muted,fontFamily:"Cinzel,serif",fontSize:14,letterSpacing:1,textTransform:"uppercase",padding:"9px 0",cursor:"pointer",transition:"all 0.2s"}}>
                  {label}
                </button>
              ))}
            </div>
            ...
            {activeTab==="reading"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:10,position:"relative",overflow:"hidden"}}>
                  ...
                  <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>✦ Your Reading ✦</div>
                  <TeaserText/>
                </div>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:10}}>
                  <div onMouseEnter={()=>setMood("warning")} onMouseLeave={()=>setMood("neutral")} style={{background:"rgba(65,8,22,0.35)",border:`1px solid ${C.roseDim}`,borderRadius:11,padding:"11px"}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.rose,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>⚠ Heed This</div>
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:16,color:C.cream,margin:0,lineHeight:1.6}}>{reading.warning}</p>
                  </div>
                  <div onMouseEnter={()=>setMood("gift")} onMouseLeave={()=>setMood("neutral")} style={{background:"rgba(15,50,38,0.35)",border:`1px solid rgba(35,100,65,0.4)`,borderRadius:11,padding:"11px"}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.teal,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>✨ Your Gift</div>
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:16,color:C.cream,margin:0,lineHeight:1.6}}>{reading.gift}</p>
                  </div>
                </div>
                {reading.nearFuture&&(
                  <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:11,padding:"12px 13px",marginBottom:10}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.goldDim,letterSpacing:2,textTransform:"uppercase",marginBottom:4}}>🌟 The Next 90 Days</div>
                ...
                {!paid&&!subscribed&&(
                  <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",marginBottom:10,textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                    ...
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",color:C.muted,fontSize:16,lineHeight:1.6,margin:"0 0 10px"}}>Full palm analysis · Past life echo · Complete mystical narrative · Fate line reading</p>
                    <div style={{display:"flex",gap:8,alignItems:"center",justifyContent:"center",margin:"10px 0"}}>
                      <span style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.muted,textDecoration:"line-through"}}>$9.99</span>
                      <span style={{fontFamily:"Cinzel,serif",fontSize:28,color:C.gold,fontWeight:700}}>$2.99</span>
                      <span style={{background:C.roseDim,color:C.rose,borderRadius:20,padding:"2px 9px",fontFamily:"Cinzel,serif",fontSize:13}}>70% OFF</span>
                    </div>
                    ...
                    <button className="rose-btn" onClick={()=>setSubscribed(true)} style={{width:"100%",padding:"10px",fontSize:16,borderRadius:11,marginBottom:6}}>🌙 Subscribe — $6.99/mo · Unlimited</button>
                    <p style={{fontFamily:"Crimson Text,serif",fontSize:15,color:C.muted,margin:0}}>Instant access · Secure · Cancel anytime</p>
                  </div>
                )}
                {(paid||subscribed)&&(
                  <div style={{animation:"fadeUp 0.6s ease both"}}>
                    <div style={{background:C.surface,border:`1px solid ${C.gold}2a`,borderRadius:14,padding:"16px",marginBottom:10}}>
                      ...
                      <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:12,textAlign:"center"}}>✦ The Full Reading ✦</div>
                      {reading.pastLife&&(
                        <div style={{background:"rgba(50,15,70,0.3)",border:`1px solid rgba(110,35,130,0.3)`,borderRadius:9,padding:"10px 11px",marginBottom:12}}>
                          <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:"#b070d8",letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>🌀 Past Life Echo</div>
                      ...
                      <Divider/>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10,textAlign:"center"}}>✦ Madame Seraphina Speaks ✦</div>
                ...
                {!paid&&!subscribed&&(
                  <button className="ghost-btn" onClick={()=>setPaid(true)} style={{width:"100%",padding:"7px",fontSize:14,borderRadius:9,marginBottom:7}}>👁 Preview Full Reading (Demo)</button>
                )}
              </div>
            )}
                  ...
                  <div key={title} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8,borderLeft:`3px solid ${color}`}}>
                    ...
                    {(paid||subscribed)?
                      ...
                      <div>
                        ...
                        <button className="ghost-btn" onClick={()=>setPaid(true)} style={{fontSize:14,padding:"4px 12px",borderRadius:18}}>🔮 Unlock — $2.99</button>
                      </div>
                    }
                  </div>
                ))}
            ...
            {activeTab==="extras"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:13,color:C.goldDim,letterSpacing:2,textTransform:"uppercase",marginBottom:6}}>🌅 Today's Fortune</div>
                  ...
                  {!subscribed&&<button className="rose-btn" onClick={()=>setSubscribed(true)} style={{width:"100%",padding:"9px",fontSize:15,borderRadius:9}}>🌙 Daily Fortunes — $6.99/month</button>}
                  {subscribed&&<p style={{fontFamily:"Cinzel,serif",fontSize:14,color:C.teal,margin:0}}>✓ Daily fortunes active</p>}
                </div>
              </div>
            )}
            ...
            <button className="ghost-btn" onClick={()=>{setPhase("intro");setReading(null);setPalmImage(null);setPaid(false);setSubscribed(false);setActiveTab("reading");setSpeaking(false);}}
              style={{width:"100%",padding:"9px",fontSize:15,borderRadius:9}}>
              🔄 Begin a New Reading
            </button>
          </div>
        )}

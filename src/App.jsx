...
function PalmScanScreen({ palmImage, palmLandmarks }) {
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080510", display:"flex", flexDirection:"column", alignItems:"center", paddingBottom:24 }}>
...
function DetailsPage({ onSubmit, onBack }) {
  ...
  return (
    <div style={{paddingTop:40,paddingBottom:24,animation:"fadeUp 0.6s ease both"}}>
      {/* Heading */}
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {phase==="result"&&reading&&(
          <div style={{paddingTop:28,paddingBottom:24,animation:"fadeUp 0.6s ease both"}}>
            <Steps current={2}/>
          ...
          <>
            ...
            {activeTab==="extras"&&(
              <button onClick={()=>{setPhase("intro");setReading(null);setPalmImage(null);setPartnerPaid(false);setFullPaid(false);setSubscribed(false);setSpeaking(false);}}
                style={{width:"100%",padding:"12px",fontSize:14,borderRadius:9,background:"rgba(148,90,210,0.18)",border:"1px solid rgba(148,90,210,0.6)",color:"#c090ff",fontFamily:"Cinzel,serif",letterSpacing:1,cursor:"pointer",marginTop:16,marginBottom:8}}>
                🔄 Begin a New Reading
              </button>
            )}
      ...
      {phase==="result"&&reading&&!partnerPhase&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,paddingTop:12,paddingBottom:24,borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
          <Link to="/privacy-policy" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",fontWeight:600}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Privacy Policy</Link>
          <span style={{color:C.border}}>•</span>
          <Link to="/terms-and-conditions" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",fontWeight:600}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Terms & Conditions</Link>
        </div>
      )}

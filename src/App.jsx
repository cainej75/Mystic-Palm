            ...
            */}
            ...
            {!partnerPhase&&activeTab==="lines"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                {userName&&<div style={{fontFamily:"cursive",fontSize:"clamp(28px,7vw,42px)",color:C.gold,textAlign:"center",marginBottom:18,marginTop:-8,letterSpacing:1}}>{userName}</div>}

...
function generateFortune(seed, userName, dob) {
  ...
  const LOVE_READINGS = [
    `Your heart line curves with rare depth, ${name}. You do not love lightly — those who have been loved by you carry it. A connection you have been cautious about is ready to be met without armour. ${bMonth} souls have a particular gravitational pull in matters of the heart — something is moving toward you that you have been unconsciously calling for longer than you know.`,
  ...
  const MONEY_READINGS = [
    ...
    `A financial pattern is completing, ${name}. Something that has been draining resources — energy, money, time — is coming to an end. The space it leaves will feel uncomfortable before it feels like freedom. Do not rush to fill it.`,
  ...
  const FUTURE_EVENTS = [
    ...
    `An unexpected source of support — practical, emotional, or financial — will reveal itself in the coming weeks. It will not come from where you have been looking.`,
  ];
  const WARNINGS = [
    ...
    `The warning is about time, ${name}. Not that you are running out of it — but that you have been spending it as though it is unlimited. It is not. One specific area of your life needs more of it, now.`,
    `Be careful of the comfort of being almost ready. At some point, almost-ready is the same as not. The stars have been patient with you on this. Their patience, like all things, has a horizon.`,
  ];
  const GIFTS = [
    ...
    `You have a specific kind of courage: the kind that does not look like courage, that moves quietly, that commits before it is certain. This is rarer than the loud kind.`,
    ...
    `${name}, you have a healing quality that operates whether you intend it or not. People leave conversations with you lighter than they arrived. Do not take this lightly — it is not small.`,
  ];
  const PAST_LIVES = [
  ...
  const luckyNumber = lifeNum;

  const greeting   = `The ancient lines speak with rare clarity for ${name} — what I see here is not common.`;
  const teaser     = `The palm does not lie, ${name}. What is encoded in your lines is both beautiful and sobering — a soul standing precisely at the edge of its most important chapter yet. There is something the universe has been building toward in your life for longer than you have been conscious of. I have shown you only the surface. The depths are far more revealing.`;
  ...
  return {
    ...
    warning, soulSign, luckyColor, luckyNumber: String(luckyNumber),

...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
    ...
    const algorithmReading = {
      ...
      lifeLine: seedFortune.lifeLine || "The lines of your life tell a story of resilience and depth. You have endured what others could not, and emerged wiser.",
      heartLine: seedFortune.love || "Your emotional nature runs deep and true. Love will find you when you are ready to receive it.",
      headLine: seedFortune.career || "Your mind is your greatest asset. The clarity you seek is closer than you know.",
      fateLine: seedFortune.money || "Prosperity is written in the convergence of your efforts and the universe's timing. Both are aligning.",
      fullReading: seedFortune.personality && seedFortune.love ? `${seedFortune.personality}\n\n${seedFortune.love}\n\n${seedFortune.warning}\n\nWhat the universe asks of you is simple: trust the unfolding.` : `${FALLBACK.fullReading}`,

          ...
          <div style={{paddingTop:28,paddingBottom:80,animation:"fadeUp 0.6s ease both"}}>
            ...
            */}
            ...
            <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12,gap:6}}>
              {[["extras","🃏","Today's Fortune"],["reading","💎","Your Gift / Warning"],["lines","🔒","Full Awakening"]].map(([id,icon,label])=>(
            ...
            {activeTab==="reading"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{width:"100%",marginBottom:10}}>
                  <div onMouseEnter={()=>setMood("gift")} onMouseLeave={()=>setMood("neutral")} style={{width:"100%",boxSizing:"border-box",background:"rgba(15,50,38,0.35)",border:`1px solid rgba(35,100,65,0.4)`,borderRadius:11,padding:"14px",marginBottom:10}}>
                  ...
                  <div onMouseEnter={()=>setMood("warning")} onMouseLeave={()=>setMood("neutral")} style={{width:"100%",boxSizing:"border-box",background:"rgba(65,8,22,0.35)",border:`1px solid ${C.roseDim}`,borderRadius:11,padding:"14px"}}>

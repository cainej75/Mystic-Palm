        ...
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
          try {
            await navigator.share({
              ...
              text: 'Check out my reading from Mysticfortunes.ai — mysticfortunes.ai',
            });
            return;
          } catch (err) {
          ...
          return (
            <div style={{marginBottom:16,paddingBottom:14,borderBottom:"1px solid rgba(201,168,76,0.27)"}}>
              <div style={{textAlign:"center",marginBottom:8}}>
                ...
                <div style={{fontFamily:"Cinzel,serif",fontSize:9,color:"#b0405a",fontWeight:600,letterSpacing:1,marginTop:4}}>{dateStr}</div>
              </div>
            ...
            <div style={{marginBottom:14}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
                {[["🌙",mSign,"Soul Sign"],["🔢",mNum,"Lucky #"],["🎨",mColor,"Colour"]].map(([ic,v,l])=>(
                  <div key={l} style={{background:"#1a1030",border:"1px solid rgba(201,168,76,0.4)",borderRadius:8,padding:"14px 6px",textAlign:"center"}}>
                    <div style={{fontSize:22,marginBottom:4,color:"#c9a84c"}}>{ic}</div>
                    <div style={{fontFamily:"IM Fell English,serif",fontSize:12,color:"#f0dfc0",lineHeight:1.3,fontWeight:600}}>{v}</div>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:8,color:"#c9a84c",fontWeight:600,letterSpacing:1,marginTop:3}}>{l}</div>
                  </div>
                ))}
              </div>
            </div>

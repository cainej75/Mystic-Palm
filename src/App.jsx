                ...
                {showPartnerDetailsPage&&!paid?(
                  ...
                  <div style={{animation:"fadeIn 0.3s ease both"}}>
                    <div style={{textAlign:"center",marginBottom:24}}>
                      ...
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:15,color:C.cream,margin:0}}>Tell me about your beloved so I can align your cosmic connection</p>
                    </div>
                    ...
                    {/* Proceed Button */}
                    <button onClick={()=>{setShowPartnerDetailsPage(false);setPaid(true);}} className="gold-btn" style={{width:"100%",padding:"14px",fontSize:16,borderRadius:11}}>

...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      {phase==="result"&&reading&&!partnerPhase&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,paddingTop:0,paddingBottom:60,borderTop:`1px solid ${C.border}`,flexWrap:"wrap",transform:"translateY(-60px)",pointerEvents:"auto"}}>
          <Link to="/privacy-policy" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",pointerEvents:"auto"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Privacy Policy</Link>
          <span style={{color:C.border}}>•</span>
          <Link to="/terms-and-conditions" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",pointerEvents:"auto"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Terms & Conditions</Link>
        </div>
      )}

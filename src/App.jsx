    ...
    <div ref={pageRef} style={{position:"fixed",inset:0,zIndex:9999,background:"#080510",overflowY:"auto",WebkitOverflowScrolling:"touch"}}>
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:10000,backdropFilter:"blur(4px)"}}>
          <div style={{background:"#100c1a",border:"2px solid #b0405a",borderRadius:16,padding:36,maxWidth:420,width:"90%",textAlign:"center"}}>
            ...
            <p style={{fontFamily:"Crimson Text,serif",fontSize:16,color:"#e8d5b8",lineHeight:1.8,margin:"0 0 24px"}}>
              Once you leave this page, your reading will be gone forever. Make sure you have saved both your <strong style={{color:"#c9a84c"}}>page image</strong> and your <strong style={{color:"#c9a84c"}}>share card</strong> before continuing.
            </p>
      ...
      <div style={{maxWidth:480,margin:"0 auto",padding:"20px 16px 80px"}}>
        ...
        <div style={{background:"rgba(201,168,76,0.06)",border:"1px solid rgba(201,168,76,0.4)",borderRadius:16,padding:"24px 20px",marginBottom:20}}>
          ...
          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:18,color:cream,margin:0,lineHeight:1.8,textAlign:"center"}}>
            {insight}
          </p>
        </div>
        ...
        <div style={{marginBottom:24}}>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
            ...
            <span style={{fontFamily:"Cinzel,serif",fontSize:17,color:gold,letterSpacing:3,textTransform:"uppercase",fontWeight:700,opacity:1}}>Your Alignment</span>
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,rgba(201,168,76,0.4),transparent)"}}/>
          </div>
          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:19,color:cream,margin:0,lineHeight:1.85,fontWeight:500}}>
            {alignment}
          </p>
        </div>
        ...
        <button onClick={savePDF} disabled={savingPage||capturing}
          style={{width:"100%",padding:"16px",fontSize:15,borderRadius:12,background:"linear-gradient(135deg,rgba(201,168,76,0.2),rgba(120,90,20,0.2))",border:"1px solid rgba(201,168,76,0.6)",color:"#c9a84c",fontFamily:"Cinzel,serif",letterSpacing:1.5,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginBottom:12,opacity:(savingPage||capturing)?0.7:1}}>
          <span style={{fontSize:20}}>📄</span>
          {savingPage ? "Generating PDF..." : "Save as PDF"}
        </button>
    ...
    const verifyPaymentOnReturn = async () => {
      ...
      if (sessionId.startsWith('free_')) {
        ...
        if (productType === 'full_revelation') {
          ...
          const restoredName1 = savedUserName1 || 'Seeker';
          setUserName(restoredName1);
          try {
            const restoredDob1 = savedBirthDate1 ? JSON.parse(savedBirthDate1) : {day:1,month:1,year:1990};
            setBirthDate(restoredDob1);
            const savedReading1 = localStorage.getItem('pendingReading');
            if (savedReading1) {
              setReading(JSON.parse(savedReading1));
            } else {
              const seed = generateSeed(restoredName1, restoredDob1);
              setReading(generateFortune(seed, restoredName1, restoredDob1));
            }
          } catch(e) {
            console.warn('reading restore failed, regenerating:', e);
            const seed = generateSeed(restoredName1, {day:1,month:1,year:1990});
            setReading(generateFortune(seed, restoredName1, {day:1,month:1,year:1990}));
          }
      ...
      try {
        ...
        if (data.valid) {
          ...
          if (data.productType === 'full_revelation') {
            ...
            const restoredName2 = savedUserName2 || 'Seeker';
            setUserName(restoredName2);
            try {
              const savedBirthDate2 = localStorage.getItem('pendingBirthDate');
              const restoredDob2 = savedBirthDate2 ? JSON.parse(savedBirthDate2) : {day:1,month:1,year:1990};
              setBirthDate(restoredDob2);
              const savedReading2 = localStorage.getItem('pendingReading');
              if (savedReading2) {
                setReading(JSON.parse(savedReading2));
              } else {
                const seed = generateSeed(restoredName2, restoredDob2);
                setReading(generateFortune(seed, restoredName2, restoredDob2));
              }
            } catch(e) {
              console.warn('reading restore failed, regenerating:', e);
              const seed = generateSeed(restoredName2, {day:1,month:1,year:1990});
              setReading(generateFortune(seed, restoredName2, {day:1,month:1,year:1990}));
            }
            localStorage.removeItem('pendingUserName');
            localStorage.removeItem('pendingBirthDate');
            localStorage.removeItem('pendingReading');

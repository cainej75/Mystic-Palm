      ...
      <div ref={shareCardRef} style={{maxWidth:330,width:"100%",background:"#080510",border:"3px solid #c9a84c",borderRadius:20,padding:"14px 10px",boxShadow:"0 0 40px rgba(201,168,76,0.3)",animation:"slideUp 0.5s ease"}}>
        ...
        {(()=>{
          ...
          return (
            <div style={{marginBottom:20,paddingBottom:16,borderBottom:"1px solid rgba(201,168,76,0.27)"}}>
              <div style={{textAlign:"center",marginBottom:10}}>
                <span style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#ffd700",letterSpacing:1.5,textTransform:"uppercase",fontWeight:600,color:"#ffd700"}}>✦ {MONTHS_LBL[curMonth]} Elements ✦</span>
              </div>
...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {phase==="intro"&&(
          <div style={{paddingTop:36,paddingBottom:0,animation:"fadeUp 0.8s ease both"}}>
            ...
            {/* Footer Links */}
            <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:12,paddingTop:10,borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
              <Link to="/privacy-policy" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#ffd700",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#ffd700"}>Privacy Policy</Link>
              <span style={{color:"#6040a0"}}>•</span>
              <Link to="/terms-and-conditions" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#ffd700",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#ffd700"}>Terms & Conditions</Link>
            </div>
          </div>
        )}
      ...
      {phase==="result"&&reading&&!partnerPhase&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,paddingTop:10,paddingBottom:20,borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
          <Link to="/privacy-policy" style={{fontFamily:"Cinzel,serif",fontSize:10,color:"#ffd700",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#ffd700"}>Privacy Policy</Link>
          <span style={{color:"#6040a0"}}>•</span>
          <Link to="/terms-and-conditions" style={{fontFamily:"Cinzel,serif",fontSize:10,color:"#ffd700",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#ffd700"}>Terms & Conditions</Link>
        </div>
      )}

...
function FullscreenCamera({ canvasRef, onCapture, onCancel }) {
  ...
  const [msg, setMsg]           = useState("Place your LEFT hand in front of the camera, palm facing you");
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      let isValid = false;
      let newMsg = "Place your LEFT hand in front of the camera, palm facing you";
      ...
      if (lm) {
        ...
        newMsg = isValid ? "Hold steady…" : "Place your LEFT hand in front of the camera, palm facing you";
      } else if (mpStatus === "loading") {
        newMsg = "Please wait while the hand detection is loading…";
      } else {
        newMsg = "Place your LEFT hand in front of the camera, palm facing you";
      }

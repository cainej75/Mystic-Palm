            ...
            {activeTab==="reading"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:10,position:"relative",overflow:"hidden"}}>
                  ...
                  <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:C.gold,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>{`✦ ${userName||"You"}, Hear This First ✦`}</div>
                  <TeaserText/>
                </div>
                ...
                {!paid&&!subscribed&&(
                  <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",marginBottom:10,textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                    ...
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",color:C.cream,fontSize:15,lineHeight:1.6,margin:"0 0 10px",fontWeight:600}}>Full palm analysis · Past life echo · Complete mystical narrative · Fate line reading</p>

...
export default function MysticFortunes() {
  ...
  // Auto-transition to biometric scan when palm is captured
  useEffect(()=>{
    if(phase==="captured" && palmImage) {
      setPhase("biometric");
    }
  },[phase,palmImage]);

  // Auto-transition to biometric scan when partner palm is captured
  useEffect(()=>{
    if(partnerPhase==="captured" && partnerPalmImage) {
      setPartnerPhase("biometric");
    }
  },[partnerPhase,partnerPalmImage]);
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {/* Captured phase auto-transitions via useEffect above */}

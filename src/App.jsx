    ...
    <div style={{position:"fixed",inset:0,zIndex:9999,background:"#080510",overflowY:"auto",WebkitOverflowScrolling:"touch"}}>
      <div style={{maxWidth:480,margin:"0 auto",padding:"20px 16px 80px"}}>
        ...
        <div style={{textAlign:"center",marginBottom:20}}>
          ...
          <div style={{fontSize:40,marginBottom:12,filter:"drop-shadow(0 0 16px rgba(176,64,90,0.6))"}}>&#x2764;&#xFE0F;</div>
        </div>
        ...
        <div style={{marginBottom:24}}>
          <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:14}}>
            ...
            <span style={{fontFamily:"Cinzel,serif",fontSize:13,color:gold,letterSpacing:3,textTransform:"uppercase",fontWeight:700,opacity:1}}>Your Alignment</span>
            <div style={{flex:1,height:1,background:"linear-gradient(90deg,rgba(201,168,76,0.4),transparent)"}}/>
          </div>
          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:16,color:cream,margin:0,lineHeight:1.85,fontWeight:500}}>
            {alignment}
          </p>
        </div>
        ...
        <div ref={cardRef} style={{background:"linear-gradient(160deg,#0c0818 0%,#100c1a 50%,#0a0614 100%)",border:"1px solid rgba(201,168,76,0.5)",borderRadius:18,padding:"28px 22px 24px",marginBottom:14,position:"relative",overflow:"hidden"}}>
          ...
          <div style={{textAlign:"center",marginBottom:16,position:"relative"}}>
            {onOneLine ? (
              ...
              <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:rose,letterSpacing:1,fontWeight:600,lineHeight:1.6,display:"flex",flexDirection:"column",alignItems:"center"}}>
                <div>{name1}</div>
        ...
        <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:15,color:"#a080b0",textAlign:"center",lineHeight:1.7,margin:"0 0 20px",padding:"0 8px",fontWeight:500,opacity:1}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:10,margin:"0 0 12px"}}>
          <div style={{flex:1,height:1,background:`linear-gradient(90deg,transparent,rgba(201,168,76,0.4))`}}/>
          <span style={{fontFamily:"Cinzel,serif",fontSize:14,color:"#c9a84c",letterSpacing:2}}>✦</span>
          <div style={{flex:1,height:1,background:`linear-gradient(90deg,rgba(201,168,76,0.4),transparent)`}}/>
        </div>

        <button onClick={()=>{onBack();setActiveTab("extras");}}
        ...
        {/* Footer Links */}
        <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:30,paddingTop:20,borderTop:`1px solid rgba(201,168,76,0.3)`,flexWrap:"wrap"}}>
                  ...
                  <div style={{animation:"fadeIn 0.3s"}}>
                    ...
                    <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px",marginBottom:20}}>
                      <div style={{marginBottom:14}}>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:6,fontWeight:700,opacity:1}}>✨ What You'll Receive</div>
                      ...
                      <div>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.rose,letterSpacing:1.5,textTransform:"uppercase",marginBottom:6,fontWeight:700,opacity:1}}>💝 Beautiful Share Card</div>

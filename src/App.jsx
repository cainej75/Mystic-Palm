    ...
    <div style={{position:"fixed",inset:0,zIndex:9999,background:"#080510",overflowY:"auto",WebkitOverflowScrolling:"touch"}}>
      <div style={{maxWidth:480,margin:"0 auto",padding:"20px 16px 80px"}}>
        ...
        <div style={{textAlign:"center",marginBottom:20}}>
          ...
          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:15,color:mutedColor,margin:0}}>
        ...
        <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:13,color:mutedColor,textAlign:"center",lineHeight:1.7,margin:"0 0 20px",padding:"0 8px"}}>
        ...
        <button onClick={onBack}
          style={{width:"100%",padding:"12px",fontSize:13,borderRadius:12,background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.1)",color:mutedColor,fontFamily:"Cinzel,serif",letterSpacing:1,cursor:"pointer"}}>
          Return to Reading
        </button>

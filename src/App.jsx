    ...
    const verifyPaymentOnReturn = async () => {
      ...
      if (sessionId.startsWith('free_')) {
        ...
        if (productType === 'full_revelation') {
          ...
          // keep pendingUserName in localStorage — useState initialiser reads it on every reload
          // keep pendingBirthDate in localStorage — cleared when user starts new session

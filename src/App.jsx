...
export default function MysticFortunes() {
  ...
  const devSkipToResult = () => {
    ...
    if (tapCountRef.current >= 5) {
      ...
      // Load mock reading and jump to result
      const mockSeed = generateSeed("Demo", {day:1,month:1,year:1990});
      const mockFortune = generateFortune(mockSeed, "Demo", {day:1,month:1,year:1990});
      setUserName("Demo");
      setBirthDate({day:1,month:1,year:1990});
      setReading({...FALLBACK,...mockFortune});
      setPalmImage(null);
      setPhase("result");
    } else {

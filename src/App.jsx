...
{/* Your Alignment section — temporarily hidden, data intact */}
        ...
        {/* Footer Links */}
        <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:8,paddingTop:16,borderTop:`1px solid rgba(201,168,76,0.3)`,flexWrap:"wrap"}}>
          <Link to="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Privacy Policy</Link>
          <span style={{color:"rgba(201,168,76,0.3)"}}>•</span>
          <Link to="/terms-and-conditions" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Terms & Conditions</Link>
        </div>
...
export default function MysticFortunes() {
  ...
  const getReading=async()=>{
    ...
    const mt="image/jpeg";
    const prompt=`You are Madame Zafira — theatrical, poetic, deeply intuitive. Examine the palm image carefully. Craft a vivid personal reading. Seeker: ${userName||"unknown"}.
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"auto"}}>
        ...
        {phase==="intro"&&(
          <div style={{paddingTop:36,paddingBottom:0,animation:"fadeUp 0.8s ease both"}}>
            ...
            <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:8,paddingTop:20,borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
              <Link to="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Privacy Policy</Link>
              <span style={{color:C.border}}>•</span>
              <Link to="/terms-and-conditions" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Terms & Conditions</Link>
            </div>
          </div>
        )}
            ...
            */}
            ...
            {!partnerPhase&&activeTab==="lines"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:6,fontWeight:700,opacity:1}}>✦ Madame Zafira Speaks</div>
                  {(fullPaid||subscribed)?
      ...
      {phase==="result"&&reading&&!partnerPhase&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:8,paddingTop:16,borderTop:`1px solid ${C.border}`,flexWrap:"wrap"}}>
          <Link to="/privacy-policy" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Privacy Policy</Link>
          <span style={{color:C.border}}>•</span>
          <Link to="/terms-and-conditions" target="_blank" rel="noopener noreferrer" style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#e8c76b",letterSpacing:1,textDecoration:"none",transition:"all 0.3s"}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color="#e8c76b"}>Terms & Conditions</Link>
        </div>

...
import MysticLogoWebP from './assets/Mystic_Fortunes_Logo_new.webp';
import MysticLogoPNG from './assets/Mystic_Fortunes_Logo_new.png';
...
Respond ONLY with this JSON (no preamble, nothing before or after): {"greeting":"${userName}, [2-3 sentences about what you see overall]","lifeLine":"[3-4 sentences about life path]","heartLine":"[3-4 sentences about emotional patterns]","headLine":"[3-4 sentences about intellectual patterns]","fateLine":"[3-4 sentences about direction]","fullReading":"[3-4 paragraphs weaving all lines together]","nearFuture":"[2-3 sentences about specific 30-90 day prediction]"}`;
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"auto"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 0 24px",position:"relative",zIndex:2}}>

        {/* ══ INTRO ══ */}
        {phase==="intro"&&(
          <div style={{paddingTop:0,paddingBottom:0,animation:"fadeUp 0.8s ease both"}}>
            {/* Logo - replaces text heading */}
            <div style={{textAlign:"center",margin:0,padding:0,animation:"fadeIn 1.2s ease both"}}>
              <picture>
                <source srcSet={MysticLogoWebP} type="image/webp"/>
                <img src={MysticLogoPNG} alt="Mystic Fortunes Logo" loading="eager" fetchpriority="high" onClick={devSkipToResult} style={{maxWidth:"100%",height:"auto",maxHeight:420,display:"block",filter:"drop-shadow(0 0 20px rgba(201,168,76,0.3))",backfaceVisibility:"hidden",WebkitFontSmoothing:"antialiased",cursor:"pointer",margin:"0 auto",padding:0}}/>
              </picture>
              {/* Subtitle */}
              <div style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:"clamp(24px,6vw,34px)",fontWeight:400,color:C.gold,margin:"0 0 24px",lineHeight:1.4,opacity:0.9,letterSpacing:0}}>Ancient wisdom, modern magic</div>
            </div>
      ...
      {phase!=="capture"&&!(activeTab==="lines"&&(fullPaid||subscribed))&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:8,paddingTop:12,paddingBottom:16,flexWrap:"wrap"}}>
          ...
          <div style={{position:"relative",display:"inline-block"}}>
            ...
            {showBlogDropdown&&(
              <div onMouseEnter={()=>setShowBlogDropdown(true)} onMouseLeave={()=>setShowBlogDropdown(false)} style={{position:"absolute",bottom:"100%",left:0,background:"#100c1a",border:`1px solid ${C.border}`,borderRadius:8,minWidth:220,zIndex:1000,marginBottom:4,boxShadow:"0 8px 24px rgba(0,0,0,0.5)"}}>

    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"auto"}}>
      ...
      {phase!=="capture"&&!(activeTab==="lines"&&(fullPaid||subscribed))&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,marginTop:8,paddingTop:12,paddingBottom:16,flexWrap:"wrap"}}>
          ...
          <span style={{color:C.border}}>•</span>
          <div style={{position:"relative",display:"inline-block"}} onMouseEnter={()=>setShowBlogDropdown(true)} onMouseLeave={()=>setShowBlogDropdown(false)}>
            ...
            {showBlogDropdown&&(
              <div style={{position:"absolute",bottom:"100%",left:0,background:"#100c1a",border:`1px solid ${C.border}`,borderRadius:8,minWidth:220,zIndex:1000,marginBottom:4,boxShadow:"0 8px 24px rgba(0,0,0,0.5)"}}>

            ...
            */}
            ...
            {!partnerPhase&&activeTab==="lines"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                {userName&&<div style={{fontFamily:"Cinzel,serif",fontSize:"clamp(26px,6vw,38px)",fontWeight:700,color:C.gold,textAlign:"center",marginBottom:18,marginTop:-8,letterSpacing:3}}>{userName}</div>}
                ...
                {(fullPaid||subscribed)&&(
                  <button
                    onClick={async()=>{
                      ...
                      try{await generateFullRevelationPDF(reading,userName,birthDate);}catch(e){console.error(e);}
                      setSavingFullPDF(false);
                    }}
                    style={{width:"100%",padding:"14px",marginBottom:10,background:"linear-gradient(135deg,#1a1200,#2a1e00)",border:"1px solid #c9a84c",borderRadius:11,color:"#c9a84c",fontFamily:"Cinzel,serif",fontSize:15,fontWeight:700,letterSpacing:1.5,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:10,textTransform:"uppercase"}}
                  >
                    {savingFullPDF?"✦ Generating PDF...":"📜 Download Your Reading as PDF"}
                  </button>
                )}

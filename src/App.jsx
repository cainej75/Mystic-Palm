...
- Make ALL sections DETAILED and RICH (4-5 sentences minimum per section)
...
- The fullReading should deeply integrate all the individual sections into one coherent narrative (5-7 paragraphs, not 8-10)
...
1. greeting (4-5 sentences): Open with what you see overall, weave in hints about the life line, heart patterns, intellectual struggles, and direction they will encounter
2. lifeLine (5-6 sentences): Deep dive into their life path, survival, resilience. Connect to their past and what it prepared them for.
3. heartLine (5-6 sentences): Their emotional patterns, capacity for love, vulnerability. How this connects to their life journey.
4. headLine (5-6 sentences): Intellectual patterns, thinking style, internal conflicts. How this relates to the choices they face.
5. fateLine (5-6 sentences): Their direction, agency, the threshold approaching. Connect to the turning point you see.
6. fullReading (5-7 paragraphs): Weave all lines together into one narrative. This is the synthesis — show how life + heart + mind + fate create the whole story. Make it resonate with inevitability.
7. nearFuture (4-5 sentences): Specific 30-90 day prediction that ties to the broader pattern revealed above.

The reading to enhance:
${JSON.stringify(reading, null, 2)}

Respond ONLY with valid JSON (no markdown, no preamble, no extra text - ONLY the JSON object): {"greeting":"4-5 sentences weaving together all the palm lines","teaser":"immediate hook about their life right now","lifeLine":"5-6 sentences deep dive","heartLine":"5-6 sentences deep dive","headLine":"5-6 sentences deep dive","fateLine":"5-6 sentences deep dive","fullReading":"5-7 paragraphs that synthesize and integrate all sections","luckyNumber":"1-9","luckyColor":"color name","soulSign":"mystical archetype 2-4 words","warning":"important caution, 2-3 sentences","gift":"hidden strength, 2-3 sentences","pastLife":"vivid past life detail, 2-3 sentences","nearFuture":"4-5 sentences about specific 30-90 day prediction"}`;

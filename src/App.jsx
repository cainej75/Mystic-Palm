    ...
    try {
      ...
      script.onload = async () => {
        try {
          ...
          // Selectively brighten non-dark pixels while preserving color
          for (let i = 0; i < data.length; i += 4) {
            ...
            if (brightness > 50) {
              data[i] = Math.min(255, r * 1.8 + 30);     // Red: More conservative boost
              data[i + 1] = Math.min(255, g * 1.8 + 30); // Green
              data[i + 2] = Math.min(255, b * 1.8 + 30); // Blue
            }

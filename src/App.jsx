...
function FullscreenCamera({ canvasRef, onCapture, onCancel }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      // Try different constraint combinations, ordered for Samsung compatibility
      const constraintVariations = [
        { video: { width:{ideal:1280}, height:{ideal:720} } },  // Simple constraints first (Samsung friendly)
        { video: { width:{ideal:1280}, height:{ideal:720}, facingMode:{ideal:"environment"} } },
        { video: { facingMode:{ideal:"environment"}, width:{ideal:1280}, height:{ideal:720} } },  // Original order
        { video:{ facingMode:"environment" } },  // Fallback without resolution

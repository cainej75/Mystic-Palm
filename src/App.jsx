...
- Speak with absolute confidence and authority. Do not use hedging language like "may," "could," or "might."
...
- Include one statement about something they know is true but rarely admit to themselves or others.
- Use their name throughout to make it feel personally addressed.
- Keep the tone mystical, slightly eerie, but ultimately reassuring.
- Do not explain palm reading or how this works. Deliver as undeniable truth.

Structure your response:
1. Opening observation that feels like you can see something others cannot
2. Insight about their personality or past
3. The current life situation or internal struggle they're navigating
4. A specific near-future turning point and what shifts
5. One closing line that feels profound and memorable

The reading to enhance:
${JSON.stringify(reading, null, 2)}

Respond ONLY with valid JSON: {"greeting":"opening statement","teaser":"immediate hook about their life right now","lifeLine":"their life path","heartLine":"what their heart line reveals","headLine":"their intellectual pattern","fateLine":"their direction ahead","fullReading":"4-5 paragraphs of enhanced mystical prose","luckyNumber":"1-9","luckyColor":"color name","soulSign":"mystical archetype 2-4 words","warning":"important caution","gift":"their hidden strength","pastLife":"vivid past life detail","nearFuture":"specific 30-90 day prediction"}`;
      ...
      if (!res.ok) {
        console.error("Claude API returned error:", data);

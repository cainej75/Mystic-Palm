...
function generateFortune(seed, userName, dob) {
  ...
  const greeting     = `The ancient lines speak with rare clarity for ${name} — what I see here is not common.`;
  const nearFuture   = futureEvent;
...
function ShareCard({reading}) {
  ...
  if (showCard) return <ShareCardView reading={reading} onClose={closeCard}/>;

  return (
    <div style={{textAlign:"center",padding:"20px 0"}}>
      <button className="gold-btn" onClick={openCard}
        style={{width:"100%",padding:"16px",fontSize:16,borderRadius:12,
          background:"linear-gradient(135deg,rgba(148,90,210,0.3),rgba(100,50,180,0.2))",
          border:"1px solid rgba(148,90,210,0.6)",color:"#c090ff",

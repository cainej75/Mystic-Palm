...
function ShareCardView({reading, onClose}) {
  ...
  return (
    <>
      ...
      <div style={{position:"fixed",left:"-9999px",top:"-9999px",width:420,pointerEvents:"none",visibility:"hidden",zIndex:-1}}>
      ...
      {/* Full screen overlay */}
      <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,zIndex:9999,background:"#050210",overflowY:"scroll",WebkitOverflowScrolling:"touch"}}>
        ...
        {rendering ? (
          ...
          <div>
            <img src={imgSrc} alt="Share Card" style={{width:"100%",display:"block",maxWidth:"100vw"}}/>
    ...
    <div style={{paddingTop:40,paddingBottom:60,animation:"fadeUp 0.6s ease both"}}>
      ...
      <div style={{textAlign:"center",marginBottom:28}}>
        ...
        <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:20,color:C.cream,margin:0,lineHeight:1.6,opacity:0.92}}>
          Madame Seraphina requires your details<br/>in order to look into your soul
        </p>
      </div>

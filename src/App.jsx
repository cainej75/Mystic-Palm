...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                {showPartnerDetailsPage&&!partnerPaid?(
                  ...
                  <div style={{animation:"fadeIn 0.3s ease both"}}>
                    ...
                    {/* Validation message */}
                    {!partnerName.trim()&&(
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:12,color:"#ffffff",textAlign:"center",marginTop:8,opacity:0.8,fontStyle:"italic"}}>Please enter your partner's name to proceed</p>
                    )}
                    {/* Back Button - Purple like navigation buttons */}
                    <button onClick={()=>{setShowPartnerDetailsPage(false);setPartnerPhase(null);}} style={{width:"100%",padding:"12px",fontSize:14,borderRadius:9,background:"rgba(148,90,210,0.18)",border:"1px solid rgba(148,90,210,0.6)",color:"#c090ff",fontFamily:"Cinzel,serif",letterSpacing:1,cursor:"pointer",marginTop:16}}>
                      ← Back to Partner Compatibility
                    </button>
                  </div>
                ):(
                  <>
      ...
      {phase==="result"&&reading&&!partnerPhase&&(
        <div style={{display:"flex",justifyContent:"center",gap:16,paddingTop:0,paddingBottom:60,borderTop:`1px solid ${C.border}`,flexWrap:"wrap",transform:"translateY(-38px)",pointerEvents:"auto",position:"relative",zIndex:10}}>
          <Link to="/privacy-policy" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",fontWeight:600,textShadow:"0 0 8px rgba(201,168,76,0.5)",pointerEvents:"auto",cursor:"pointer",position:"relative",zIndex:10}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Privacy Policy</Link>
          <span style={{color:C.gold,textShadow:"0 0 6px rgba(201,168,76,0.6)",fontWeight:600}}>•</span>
          <Link to="/terms-and-conditions" style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:1,textDecoration:"none",transition:"all 0.3s",fontWeight:600,textShadow:"0 0 8px rgba(201,168,76,0.5)",pointerEvents:"auto",cursor:"pointer",position:"relative",zIndex:10}} onMouseEnter={(e)=>e.target.style.color=C.rose} onMouseLeave={(e)=>e.target.style.color=C.gold}>Terms & Conditions</Link>
        </div>
      )}

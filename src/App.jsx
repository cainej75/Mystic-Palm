    ...
    <div style={{position:"fixed",inset:0,zIndex:9999,background:"#080510"}}>
      ...
      <div style={{position:"absolute",bottom:0,left:0,right:0,padding:"0 20px 48px",pointerEvents:"none"}}>
        <div style={{background:"rgba(8,5,16,0.88)",border:"1px solid rgba(148,90,210,0.45)",borderRadius:12,padding:"14px 22px",display:"flex",alignItems:"center",gap:14,backdropFilter:"blur(16px)"}}>
          ...
          <span style={{fontFamily:"Cinzel,serif",fontSize:17,color:"#9b5fd4",letterSpacing:2.5,textTransform:"uppercase",animation:"fadeIn 0.3s ease"}} key={status}>{status}</span>
        </div>
      </div>
    </div>
  );
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {phase==="loading"&&(
          <div style={{position:"fixed",inset:0,zIndex:80,background:"rgba(8,5,16,0.96)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:24}}>
            ...
            <div style={{fontFamily:"Cinzel,serif",fontSize:20,color:"#f5d060",letterSpacing:3,textTransform:"uppercase",animation:"auraPulse 2s ease-in-out infinite",textShadow:"0 0 16px rgba(245,208,96,0.8)"}}>Reading your ancient lines…</div>
          </div>
        )}
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:10}}>
                  <div onMouseEnter={()=>setMood("warning")} onMouseLeave={()=>setMood("neutral")} style={{background:"rgba(65,8,22,0.35)",border:`1px solid ${C.roseDim}`,borderRadius:11,padding:"11px"}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:C.rose,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>⚠ Heed This</div>
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.6}}>{reading.warning}</p>
                  </div>
                  <div onMouseEnter={()=>setMood("gift")} onMouseLeave={()=>setMood("neutral")} style={{background:"rgba(15,50,38,0.35)",border:`1px solid rgba(35,100,65,0.4)`,borderRadius:11,padding:"11px"}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:C.teal,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>✨ Your Gift</div>
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.6}}>{reading.gift}</p>
                  </div>
                </div>
                {reading.nearFuture&&(
                  <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:11,padding:"12px 13px",marginBottom:10}}>
                    ...
                    <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:18,color:C.cream,margin:0,lineHeight:1.85}}>{reading.nearFuture}</p>
                  </div>
                )}
                {!paid&&!subscribed&&(
                    ...
                    <div style={{background:C.surface,border:`1px solid ${C.gold}2a`,borderRadius:14,padding:"16px",marginBottom:10}}>
                      ...
                      {reading.pastLife&&(
                        <div style={{background:"rgba(50,15,70,0.3)",border:`1px solid rgba(110,35,130,0.3)`,borderRadius:9,padding:"10px 11px",marginBottom:12}}>
                          ...
                          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:18,color:C.cream,margin:0,lineHeight:1.8}}>{reading.pastLife}</p>
                        </div>
                      )}
                      {[["💗 Heart Line",reading.heartLine],["🧠 Head Line",reading.headLine],["✋ Life Line",reading.lifeLine],["⭐ Fate Line",reading.fateLine]].map(([title,text])=>(
                        <div key={title} style={{marginBottom:12,paddingBottom:12,borderBottom:`1px solid ${C.border}`}}>
                          ...
                          <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:18,color:C.cream,margin:0,lineHeight:1.85}}>{text}</p>
                        </div>
                      ))}
                      <Divider/>
            ...
            {activeTab==="extras"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                  ...
                  <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:18,color:C.cream,margin:"0 0 8px",lineHeight:1.85}}>"The universe conspires in your favour today — but only if you take the first step. Something you have been waiting for permission to begin needs no permission but your own."</p>

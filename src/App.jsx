                ...
                {showPartnerDetailsPage?(
                  ...
                  <div style={{animation:"fadeIn 0.3s"}}>
                    ...
                    <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"16px",marginBottom:20}}>
                      <div>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.rose,letterSpacing:1.5,textTransform:"uppercase",marginBottom:6,fontWeight:700,opacity:1}}>💝 Receive a Beautiful Share Card</div>
                    ...
                    <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                      ...
                      <div style={{display:"flex",gap:8,alignItems:"center",justifyContent:"center",margin:"12px 0 16px"}}>
                        ...
                        <span style={{fontFamily:"Cinzel,serif",fontSize:36,color:C.gold,fontWeight:700}}>$3.99</span><span style={{fontFamily:"Cinzel,serif",fontSize:13,color:"#ff4444",fontWeight:700,background:"rgba(255,68,68,0.15)",border:"1px solid #ff4444",borderRadius:6,padding:"3px 8px",marginLeft:10,letterSpacing:1}}>60% OFF</span>
                      </div>

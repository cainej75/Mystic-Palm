...
CRITICAL: Make all sections LONGER and MORE DETAILED. Each section should be 3-4 substantive sentences minimum. The fullReading opening ("Madame Zafira Speaks") should reference and weave together insights about what you will reveal in the Life Line, Heart Line, Head Line, and Fate Line sections — set the stage for what follows.
...
- Use ${userName}'s name throughout to make it feel personally addressed.
- Keep the tone mystical, slightly eerie, but ultimately reassuring.
- Do not explain palm reading. Deliver as undeniable truth.

Structure the fullReading/greeting section:
1. Opening: Acknowledge what you see in their palm overall
2. Set the stage: Weave in hints about their life path, heart patterns, intellectual struggles, and direction
3. Bridge: Explain what the lines show about their past and present
4. Preview: Reference the specific turning point and near-future shift you see
5. Closing: One profound, memorable line about their readiness or transformation

Then make each individual section (lifeLine, heartLine, headLine, fateLine, gift, warning, pastLife, nearFuture) DETAILED and SUBSTANTIAL — 2-3 full sentences each, not one-liners.

The reading to enhance:
${JSON.stringify(reading, null, 2)}

Respond ONLY with valid JSON: {"greeting":"4-5 paragraphs that reference and weave together the palm lines you will describe in other sections","teaser":"immediate hook about their life right now","lifeLine":"3-4 sentences about their life path","heartLine":"3-4 sentences about love, vulnerability, and emotional patterns","headLine":"3-4 sentences about intellectual patterns and thinking","fateLine":"3-4 sentences about direction and choice points ahead","fullReading":"5-7 paragraphs of enhanced mystical prose that ties everything together","luckyNumber":"1-9","luckyColor":"color name","soulSign":"mystical archetype 2-4 words","warning":"2-3 sentences of important caution","gift":"2-3 sentences about their hidden strength","pastLife":"2-3 sentences about a vivid past life detail","nearFuture":"3-4 sentences about specific 30-90 day prediction"}`;

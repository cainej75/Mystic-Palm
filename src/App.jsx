...
function FullScreenShareCard({reading, userName, birthDate, onClose}) {
  ...
  const handleShare = async () => {
    try {
      ...
      canvas.toBlob(async (blob) => {
        ...
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
          try {
            await navigator.share({
              ...
              text: 'Check out my reading from Mysticfortunes.ai',
              url: 'https://mysticfortunes.ai',
            });
            return;
          } catch (err) {
        ...
        a.href = url; a.download = 'mystic-fortune.png';
        document.body.appendChild(a); a.click(); document.body.removeChild(a);
        try { await navigator.clipboard.writeText('https://mysticfortunes.ai'); } catch(e) {}
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"linear-gradient(160deg,rgba(8,3,20,0.98) 0%,rgba(40,8,25,0.98) 50%,rgba(8,3,20,0.98) 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px",zIndex:1000,overflowY:"auto"}}>
      ...
      <div ref={shareCardRef} style={{maxWidth:330,width:"100%",background:"#080510",border:"3px solid #c9a84c",borderRadius:20,padding:"14px 10px",boxShadow:"0 0 40px rgba(201,168,76,0.3)"}}>
        ...
        {(()=>{
          ...
          const DF = [
            `The universe conspires in your favour today, ${n} — but only if you take the first step.`,
            `Today carries an unusual momentum, ${n}. The action you have been postponing is precisely what the universe is waiting for.`,
            `A door that has been closed for some time is looser on its hinges today, ${n}. A gentle push is all it requires.`,
            `The stars have cleared a path for you today, ${n}. Walk forward without waiting for confirmation.`,
            `Today is not a day for planning, ${n}. It is a day for doing the thing the plan has been delaying.`,
            `Something small you do today, ${n}, will have a disproportionately large effect.`,
            `The hesitation you have been feeling is not intuition warning you away, ${n}. It is habit.`,
            `Today brings a narrow window, ${n}. Move when you feel the pull.`,
            `The energy today favours beginnings, ${n}. Whatever you start carries further than what you start later.`,
            `A conversation you have been avoiding will be easier today than tomorrow, ${n}.`,
          ];
            ...
            <div style={{marginBottom:14}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
                {[["🌙",mSign,"Soul Sign"],["🔢",mNum,"Lucky #"],["🎨",mColor,"Colour"]].map(([ic,v,l])=>(
                  <div key={l} style={{background:"rgba(255,215,0,0.08)",border:"1px solid rgba(201,168,76,0.27)",borderRadius:8,padding:"14px 6px",textAlign:"center"}}>
                    <div style={{fontSize:22,marginBottom:4,color:"#c9a84c"}}>{ic}</div>
                    <div style={{fontFamily:"IM Fell English,serif",fontSize:12,color:"#e8d5b8",lineHeight:1.3,fontWeight:500}}>{v}</div>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:8,color:"#c9a84c",fontWeight:600,letterSpacing:1,marginTop:3,opacity:0.9}}>{l}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* Share button OUTSIDE the card so it isn't captured */}
      <button onClick={handleShare} style={{marginTop:20,background:"linear-gradient(135deg,#b0405a,#5c1a2a)",border:"none",color:"white",borderRadius:10,padding:"12px 30px",fontSize:12,fontFamily:"Cinzel,serif",fontWeight:600,cursor:"pointer",letterSpacing:1,textTransform:"uppercase"}}>
        ✨ Share Card
      </button>
    </div>
  );

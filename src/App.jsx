          ...
          <div style={{paddingTop:28,paddingBottom:20,animation:"fadeUp 0.6s ease both"}}>
            ...
            */}
            ...
            {!partnerPhase&&activeTab==="lines"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{textAlign:"center",marginBottom:20}}>
                  {userName&&<div style={{fontFamily:"Cinzel,serif",fontSize:"clamp(26px,6vw,38px)",fontWeight:700,color:"#cc0000",letterSpacing:4,textTransform:"uppercase",marginBottom:6}}>{userName}</div>}
                  {(()=>{
                    const MONTHS=['January','February','March','April','May','June','July','August','September','October','November','December'];
                    ...
                    return dobStr ? (
                      <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:"#cc0000",letterSpacing:2,marginBottom:4}}>
                        {dobStr}{zodiac ? <span style={{marginLeft:10}}>{zodiac.emoji} {zodiac.sign}</span> : null}
                      </div>
                    ) : null;
                  })()}
                  <div style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:14,color:"#cc0000",letterSpacing:1.5}}>✦ A Personal Palm Reading by Madame Zafira ✦</div>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:14,color:"#cc0000",letterSpacing:1.5,marginTop:4}}>{new Date().toLocaleDateString('en-AU',{day:'numeric',month:'long',year:'numeric'})}</div>
                </div>
                {[["🧠 Head Line",reading.headLine,"#6070d8"],["💗 Heart Line",reading.heartLine,C.rose],["✋ Life Line",reading.lifeLine,C.teal]].map(([title,text,color])=>(

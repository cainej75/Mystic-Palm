...
function FullScreenShareCard({reading, userName, birthDate, onClose}) {
    ...
    try {
      ...
      script.onload = async () => {
        try {
          ...
          // Brighten specific text and graphics elements, keep background dim
          const ctx = canvas.getContext('2d');
          const imageData = ctx.getImageData(0, 0, canvas.width, canvas.height);
          const data = imageData.data;
          
          // Selectively brighten non-dark pixels (text, gold, light colors) while keeping dark background
          for (let i = 0; i < data.length; i += 4) {
            ...
            // Only brighten pixels that aren't very dark (>50 brightness)
            if (brightness > 50) {
              data[i] = Math.min(255, r * 3.5 + 100);     // Red: 3.5x + 100 boost (more visible)
              data[i + 1] = Math.min(255, g * 3.5 + 100); // Green
              data[i + 2] = Math.min(255, b * 3.5 + 100); // Blue
            }
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"linear-gradient(160deg,rgba(8,3,20,0.98) 0%,rgba(40,8,25,0.98) 50%,rgba(8,3,20,0.98) 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px",zIndex:1000}}>
      ...
      <div ref={shareCardRef} style={{maxWidth:330,width:"100%",background:C.bg,border:`3px solid ${C.gold}`,borderRadius:20,padding:"14px 10px",boxShadow:`0 0 40px rgba(201,168,76,0.3)`,animation:"slideUp 0.5s ease"}}>
        
        {/* Heading */}
        <div style={{textAlign:"center",marginBottom:12}}>
          <div style={{fontFamily:"IM Fell English,serif",fontSize:32,fontStyle:"italic",color:C.gold,marginBottom:2,letterSpacing:1}}>Mystic Fortunes</div>
        </div>
        
        {/* Person's Name */}
        <div style={{marginBottom:10,textAlign:"center"}}>
          <div style={{fontFamily:"Crimson Text,serif",fontSize:28,color:C.gold,fontStyle:"italic"}}>{userName}</div>
        </div>
        ...
        {(()=>{
          ...
          return (
            <div style={{marginBottom:20,paddingBottom:16,borderBottom:`1px solid ${C.gold}44`}}>
              ...
              <p style={{fontFamily:"Crimson Text,serif",fontSize:15,color:"#ffffff",lineHeight:1.8,margin:0,fontStyle:"italic",textAlign:"center"}}>{`"${todayFortune}"`}</p>
            </div>
          );
        })()}
            ...
            <div style={{marginBottom:20,paddingBottom:16,borderBottom:`1px solid ${C.gold}44`}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
                {[["🌙",mSign,"Soul Sign"],["🔢",mNum,"Lucky #"],["🎨",mColor,"Colour"]].map(([ic,v,l])=>(
                  <div key={l} style={{background:"rgba(255,215,0,0.08)",border:`1px solid ${C.gold}44`,borderRadius:8,padding:"8px 5px",textAlign:"center"}}>
                    <div style={{fontSize:18,marginBottom:2}}>{ic}</div>
                    <div style={{fontFamily:"IM Fell English,serif",fontSize:11,color:"#ffffff",lineHeight:1.3,fontWeight:500}}>{v}</div>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:7,color:"#ffffff",letterSpacing:1,marginTop:2,opacity:0.9}}>{l}</div>
                  </div>
                ))}
              </div>
            </div>
                    ...
                    return (
                      <div>
                        <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:12,marginBottom:10}}>
                          ...
                          <div style={{fontFamily:"Cinzel,serif",fontSize:11,color:"#c9a84c",letterSpacing:1}}>{dateStr}</div>
                        </div>
                      </div>
                    );
                  })()}

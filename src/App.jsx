...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    {(phase==="freeze" && palmImage) || (partnerPhase==="freeze" && partnerPalmImage)?(
      <>
        {console.log(">>> FreezeFrame RENDERING, phase=", phase, "partnerPhase=", partnerPhase, "palmImage?=", !!palmImage, "partnerPalmImage?=", !!partnerPalmImage)}
        <FreezeFrame
          palmImage={partnerPhase==="freeze"?partnerPalmImage:palmImage}
          palmLandmarks={partnerPhase==="freeze"?partnerPalmLandmarks:palmLandmarks}
          onDone={(valid)=>{
            console.log("FreezeFrame onDone called, valid=", valid, "partnerPhase=", partnerPhase);
            if(partnerPhase==="freeze"){
              console.log("Partner freeze detected, valid=", valid);
              if (!valid) { setPartnerPalmError(true); setPartnerPhase("capture"); }
              else setPartnerPhase("biometric");
            }else{
              console.log("User freeze detected, valid=", valid);
    ...
    {(phase==="biometric" && palmImage && !palmError) || (partnerPhase==="biometric" && partnerPalmImage && !partnerPalmError)?(
      <>
        {console.log(">>> BiometricScan RENDERING, phase=", phase, "partnerPhase=", partnerPhase, "palmImage?=", !!palmImage, "partnerPalmImage?=", !!partnerPalmImage)}
        <BiometricScan
          ...
          onComplete={()=>{
            console.log("BiometricScan onComplete called, partnerPhase=", partnerPhase);
            if(partnerPhase==="biometric"){
              console.log("Partner biometric complete");
              ...
              console.log("User biometric complete");
              getReading();
            }
          }}
        />
    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {(phase==="capture"&&cameraOn) || (partnerPhase==="capture"&&partnerCameraOn)?(
          <>
            {console.log(">>> FullscreenCamera RENDERING, phase=", phase, "cameraOn=", cameraOn, "partnerPhase=", partnerPhase, "partnerCameraOn=", partnerCameraOn)}
            <FullscreenCamera
              canvasRef={partnerPhase==="capture"?partnerCanvasRef:canvasRef}
              onCapture={(img,lm)=>{
                console.log("=== onCapture CALLED ===");
                console.log("partnerPhase=", partnerPhase);
                console.log("img exists?", !!img);
                console.log("lm exists?", !!lm);
                if(partnerPhase==="capture"){
                  console.log(">>> Setting partner state: palmImage, landmarks, phase->freeze");
                  setPartnerPalmImage(img);
                  if(lm)setPartnerPalmLandmarks(lm);
                  setPartnerPhase("freeze");
                }else{
                  console.log(">>> Setting user state: palmImage, landmarks, phase->freeze");
                  setPalmImage(img);
                ...
                stopCamera();
                console.log("=== onCapture COMPLETE ===");
              }}
              onCancel={()=>{stopCamera();}}
            />
          </>
      ...
      {/* ══ PARTNER PALM ERROR ══ */}
      {partnerPalmError&&(
        <div style={{position:"fixed",inset:0,zIndex:50,background:"radial-gradient(ellipse at center,transparent 30%,rgba(8,5,16,0.95) 100%)",display:"flex",alignItems:"center",justifyContent:"center",padding:"0 16px"}}>
          <div style={{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"}}>
            {[...Array(8)].map((_,i)=>(
              <div key={i} style={{
                position:"absolute",

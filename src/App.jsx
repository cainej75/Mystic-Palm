                ...
                return (
                  <>
                    <div style={{textAlign:"center",marginBottom:8}}>
                      <span style={{fontFamily:"Cinzel,serif",fontSize:10,color:C.gold,letterSpacing:3,textTransform:"uppercase",opacity:0.8}}>
                        ✦ {MONTHS_LBL[curMonth]} Elements ✦
                      </span>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:12,color:C.muted,margin:"3px 0 0",lineHeight:1.4}}>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:8,marginBottom:12}}>
                      {[["🌙",mSign,"Soul Sign"],["🔢",mNum,"Lucky #"],["🎨",mColor,"Colour"]].map(([ic,v,l])=>(
                        <div key={l} style={{background:C.surface,border:`1px solid ${C.gold}33`,borderRadius:10,padding:"10px 7px",textAlign:"center"}}>
                          <div style={{fontSize:24,marginBottom:3}}>{ic}</div>
                          <div style={{fontFamily:"IM Fell English,serif",fontSize:13,color:C.cream,lineHeight:1.3}}>{v}</div>
            ...
            {activeTab==="extras"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                  ...
                  <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:"0 0 8px",lineHeight:1.85}}>"The universe conspires in your favour today — but only if you take the first step. Something you have been waiting for permission to begin needs no permission but your own."</p>

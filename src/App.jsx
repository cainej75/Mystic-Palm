...
- Make ALL sections DETAILED and RICH (3-4 sentences minimum per section)
...
- The fullReading should deeply integrate all the individual sections into one coherent narrative (4-5 paragraphs)
...
CRITICAL: Return ONLY the JSON object. Do not include any preamble, explanation, or text before or after the JSON. The response should begin with { and end with }.

Structure your response:
1. greeting (3-4 sentences): Open with what you see overall, weave in hints about the life line, heart patterns, intellectual struggles, and direction they will encounter
2. lifeLine (4-5 sentences): Deep dive into their life path, survival, resilience. Connect to their past and what it prepared them for.
3. heartLine (4-5 sentences): Their emotional patterns, capacity for love, vulnerability. How this connects to their life journey.
4. headLine (4-5 sentences): Intellectual patterns, thinking style, internal conflicts. How this relates to the choices they face.
5. fateLine (4-5 sentences): Their direction, agency, the threshold approaching. Connect to the turning point you see.
6. fullReading (4-5 paragraphs): Weave all lines together into one narrative. This is the synthesis — show how life + heart + mind + fate create the whole story. Make it resonate with inevitability.
7. nearFuture (3-4 sentences): Specific 30-90 day prediction that ties to the broader pattern revealed above.

The reading to enhance:
${JSON.stringify(reading, null, 2)}

Respond ONLY with valid JSON (no markdown, no preamble, no extra text - ONLY the JSON object): {"greeting":"3-4 sentences weaving together all the palm lines","teaser":"immediate hook about their life right now","lifeLine":"4-5 sentences deep dive","heartLine":"4-5 sentences deep dive","headLine":"4-5 sentences deep dive","fateLine":"4-5 sentences deep dive","fullReading":"4-5 paragraphs that synthesize and integrate all sections","luckyNumber":"1-9","luckyColor":"color name","soulSign":"mystical archetype 2-4 words","warning":"important caution, 2-3 sentences","gift":"hidden strength, 2-3 sentences","pastLife":"vivid past life detail, 2-3 sentences","nearFuture":"3-4 sentences about specific 30-90 day prediction"}`;
      ...
      try {
        ...
        // Strategy 2: If that fails, try finding content between first { and last }
        if (!jsonMatch) {
          const firstBrace = text.indexOf('{');
          const lastBrace = text.lastIndexOf('}');
          if (firstBrace !== -1 && lastBrace !== -1 && firstBrace < lastBrace) {
            jsonMatch = [text.substring(firstBrace, lastBrace + 1)];
            console.log("Using brace extraction strategy");
          }
        }
        ...
        try {
          claudeR = JSON.parse(jsonMatch[0]);

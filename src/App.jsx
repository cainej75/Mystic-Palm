            ...
            <div style={{animation:"fadeIn 0.6s ease both"}}>
              ...
              <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12,gap:6}}>
                {[["extras","🃏","Today's Fortune"],["reading","💖","Partner Compatibility"],["lines","💎","Full Revelation"]].map(([id,icon,label])=>(
                  <button key={id} onClick={()=>{setPartnerPhase(null);setActiveTab(id);}} className="result-tab"
              ...
              <button onClick={()=>{setPartnerPhase(null);setActiveTab("extras");}} style={{width:"100%",padding:"9px",fontSize:14,borderRadius:9,background:"rgba(148,90,210,0.18)",border:"1px solid rgba(148,90,210,0.6)",color:"#c090ff",fontFamily:"Cinzel,serif",letterSpacing:1,cursor:"pointer"}}>
                ← Back to Today's Fortune
              </button>
            </div>
          )}

          ...
          <>
            <video
              ...
              style={{
                ...
                height:"100%",
                objectFit:"cover",
                transform:"translate(-48%, -50%) scale(1.14)",
                display:"block",
...
function DesktopGate() {
  // Start false so mobile never sees a flash of the overlay on first render
  ...
  return (
    <div style={{position:'fixed',inset:0,zIndex:99999,background:'#080510',display:'flex',alignItems:'center',justifyContent:'center',flexDirection:'column'}}>
      <style>{`
      ...
      <div style={{maxWidth:480,textAlign:'center',padding:'0 32px',animation:'desktopFade 1s ease 0.4s both'}}>
        <p style={{fontFamily:'IM Fell English,serif',fontStyle:'italic',fontSize:'clamp(18px,1.8vw,24px)',color:'#e8d5b8',lineHeight:1.9,margin:'0 0 20px',opacity:0.92}}>
          "The ancient lines of the palm can only be read by candlelight —<br/>and candlelight lives in your hand."
        </p>

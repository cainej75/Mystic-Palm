...
function FullscreenCamera({ canvasRef, onCapture, onCancel }) {
  ...
  const [msg, setMsg]           = useState("Place your LEFT hand in front of the camera, inside the outline, palm facing YOU");
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      let isValid = false;
      let newMsg = "Place your LEFT hand in front of the camera, inside the outline, palm facing YOU";
      ...
      if (lm) {
        ...
        newMsg = isValid ? "Hold steady…" : "Place your LEFT hand in front of the camera, inside the outline, palm facing YOU";
      } else if (mpStatus === "loading") {
        newMsg = "Please wait while the hand detection is loading…";
      } else {
        newMsg = "Place your LEFT hand in front of the camera, inside the outline, palm facing YOU";
      }

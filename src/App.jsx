...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
  ...
  return(
    ...
    {phase==="biometric"&&palmImage&&!palmError&&(
      <BiometricScan
        palmImage={palmImage}
        palmLandmarks={palmLandmarks}
        onComplete={()=>getReading()}
      />
    )}
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:540,margin:"0 auto",padding:"0 16px 90px",position:"relative",zIndex:2}}>
        ...
        {phase==="capture"&&cameraOn&&(
          <FullscreenCamera
            canvasRef={canvasRef}
            onCapture={(img,lm)=>{setPalmImage(img);if(lm)setPalmLandmarks(lm);stopCamera();setPhase("freeze");}}
            onCancel={()=>{stopCamera();}}
          />
        )}
                ...
                {!paid&&!subscribed&&(
                  <div style={{animation:"fadeIn 0.3s"}}>
                    ...
                    <div style={{background:C.bg,border:`2px solid ${C.gold}`,borderRadius:14,padding:"16px",marginBottom:12,textAlign:"center",position:"relative",overflow:"hidden",maxWidth:280,margin:"0 auto 12px"}}>
                      ...
                      <div style={{fontFamily:"Cinzel,serif",fontSize:24,color:C.gold,marginBottom:8,letterSpacing:2}}>✦ Mystic Fortunes ✦</div>
                      
                      <div style={{fontFamily:"Cinzel,serif",fontSize:16,color:C.gold,marginBottom:3}}>Soulmate Connection</div>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.goldDim,letterSpacing:1,marginBottom:12}}>{userName||"Your Name"} & Your Partner</div>
                      
                      <div style={{height:1,background:`linear-gradient(90deg,transparent,${C.gold}44,transparent)`,marginBottom:12}}/>
                      
                      <div style={{marginBottom:12}}>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:10,color:C.goldDim,letterSpacing:1,textTransform:"uppercase",marginBottom:3}}>Date</div>
                        <div style={{fontFamily:"Crimson Text,serif",fontSize:12,color:C.cream}}>{dateStr}</div>
                      </div>
                      
                      <div style={{marginBottom:12}}>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:32,color:C.rose,fontWeight:700}}>{compat.score}%</div>
                        <div style={{fontFamily:"Cinzel,serif",fontSize:9,color:C.roseDim,letterSpacing:1,textTransform:"uppercase"}}>Harmony Score</div>
                      </div>
                    ...
                    {/* Monthly Alignment Explanation */}
                    <div style={{background:`rgba(42, 138, 122, 0.15)`,border:`1px solid ${C.teal}44`,borderRadius:12,padding:"14px",marginBottom:20}}>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:13,color:C.teal,letterSpacing:1.5,textTransform:"uppercase",marginBottom:6}}>🌙 Monthly Alignment</div>
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:14,color:C.cream,margin:"0 0 8px",lineHeight:1.7}}>Your compatibility score and insights evolve each month as the cosmic energies influencing your relationship shift and transform.</p>
                      <p style={{fontFamily:"Crimson Text,serif",fontSize:13,color:C.goldDim,margin:0,lineHeight:1.6}}>To unlock the next month's reading, you'll need to unlock this reading again. Each month brings new cosmic alignments and fresh insights into your connection.</p>
                    </div>
                    ...
                    <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                      ...
                      <button className="gold-btn" onClick={()=>setPaid(true)} style={{width:"100%",padding:"14px",fontSize:16,borderRadius:11}}>💝 Unlock Partner Reading — $2.99</button>
                    </div>
                        </>
                      );
                    })()}
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                {[["💗 Heart Line",reading.heartLine,C.rose],["🧠 Head Line",reading.headLine,"#6070d8"],["✋ Life Line",reading.lifeLine,C.teal]].map(([title,text,color])=>(
                  <div key={title} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8,borderLeft:`3px solid ${color}`}}>
                    ...
                    {(paid||subscribed)?
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:19,color:C.cream,margin:0,lineHeight:1.85}}>{text}</p>:
                      <div>
                        <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(text||"").slice(0,80)}…</p>
                      </div>
                    }
                  </div>
                ))}
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  ...
                  {(paid||subscribed)?
                    ...
                    <div>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(reading.gift||"").slice(0,80)}…</p>
                    </div>
                  }
                </div>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  ...
                  {(paid||subscribed)?
                    ...
                    <div>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(reading.warning||"").slice(0,80)}…</p>
                    </div>
                  }
                </div>
                ...
                <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  ...
                  {(paid||subscribed)?
                    ...
                    <div>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(reading.nearFuture||"").slice(0,80)}…</p>
                    </div>
                  }
                </div>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  ...
                  {(paid||subscribed)?
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:19,color:C.cream,margin:0,lineHeight:1.85}}>{reading.pastLife}</p>:
                    <div>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(reading.pastLife||"").slice(0,80)}…</p>
                    </div>
                  }
                </div>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
                  ...
                  {(paid||subscribed)?
                    ...
                    <div>
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:17,color:C.cream,margin:0,lineHeight:1.85}}>{(reading.fullReading||"").slice(0,100)}…</p>
                    </div>
                  }
                </div>

...
function generateFortune(seed, userName, dob) {
  ...
  const CAREER_READINGS = [
    `Your head line runs long and clear — a mind built for strategy and vision that outpaces the structures you have been placed within. The coming months carry a professional inflection point that will feel like disruption and is actually acceleration. Life number ${lifeNum} souls thrive when they stop performing competence and start simply being it.`,
    `There is a crossroads visible in your palm, ${name}. Two paths. One is safe and maps cleanly to what you have already proven. The other carries risk but also the kind of work that makes the first option feel like a costume you have been wearing. You already know which one calls to you. The delay has not been indecision — it has been preparation.`,
    `The fate line speaks of a professional identity you have not yet fully stepped into. There is work you are meant to do in the world that the world has not seen yet. You have been circling it — naming it to yourself in private and then finding reasons why now is not the time. The lines say now is the time.`,
    `Your head line indicates someone whose greatest career challenge has never been ability — it has been authority. Specifically, the authority to believe that what you see is worth building, and that your vision does not require external validation before it becomes real.`,
    `A significant professional shift is encoded in your lines for the next 90-day cycle, ${name}. Not necessarily a dramatic event — sometimes the shift is internal first. A decision you have been circling will crystallise. The window for making it on your own terms is open, but it will not remain open indefinitely.`,
    `The head and fate lines converge in a pattern I associate with people who are in the middle of becoming something the world does not yet have language for. The frustration you feel is not failure — it is the friction of a new form trying to emerge through structures that were not built to hold it.`,
    `Your professional line carries the mark of someone who has been working in the wrong direction — not wrong in effort, but wrong in orientation. The compass is about to correct. Something you dismissed as impractical six months ago deserves a second look.`,
    `There is a collaboration or partnership visible in your professional lines, ${name} — someone whose skills are precisely what yours are not. The meeting may have already happened without you recognising its significance. Look again at recent connections.`,
    `The head line speaks of a mind that works best outside the container it has been placed in. The constraints you have been navigating — institutional, financial, relational — are not permanent features of your professional landscape. One of them is about to be removed.`,
    `Your fate line carries the specific mark of someone whose greatest work will come from the intersection of two things they have always kept separate. A bridge is forming. The professional leap that feels irrational is not irrational — it is just ahead of the evidence.`,
    `Something you built, created, or put into the world in the last two years is about to return value that was not immediately visible. Professional work has a delayed acknowledgment pattern for ${bMonth} births — the lag is ending.`,
    `The head line reveals a thinker who has been in execution mode for too long. The work requires you to return to the generative phase — to allow the larger questions back in before the next chapter of your career can take its proper shape.`,
    `A mentor or advocate — someone with both belief in your work and the position to act on that belief — is either already in your orbit or approaching it. The lines say you will need to be visible enough to be found. This is not the time for strategic invisibility.`,
    `Your professional line tells of someone who has been undercompensated — financially, recognitionally, or both — for a significant period. The market is correcting. An offer, opportunity, or renegotiation is approaching that will reset the terms.`,
    `The convergence of your head and fate lines at this point suggests a professional decision made in the next quarter will have a disproportionate impact on the next several years. It will not look as large as it is from the inside. Trust the weight of it anyway.`,
    `There is unfinished professional work in your past — a project, a direction, a version of yourself — that deserves to be revisited. What you abandoned for practical reasons contained something real. The lines say the time for returning to it is closer than it has been.`,
    `Your career line carries the mark of someone who will be recognised significantly later than their talent warrants — but recognised in a way that makes the wait make sense. The period of invisible labour is completing.`,
    `${name}, the professional world has been asking you to be legible in ways that require you to diminish what makes your work genuinely distinctive. The next chapter asks the opposite. Stop translating yourself for audiences that cannot hold the original.`,
  ];
  ...
  const FUTURE_EVENTS = [
    `In the next 90 days, ${name}, an unexpected encounter will reframe how you see your own potential. You will recognise it by the specific way it makes you simultaneously terrified and absolutely certain.`,
    `Before the season turns, a door you stopped looking at will reopen. Go through it without overanalysing — the time for caution on this specific thing is over.`,
    `A message, a meeting, or a moment of startling stillness will arrive with unusual clarity. Pay attention to what you feel in the first ten seconds — that response is the truth before the mind edits it into something more manageable.`,
    `Something you have been carrying for a very long time is ready to be set down. The universe will offer you the moment. It will feel small. Take it anyway — the weight it removes will be disproportionate to the size of the action.`,
    `An alliance is forming — professional, personal, or creative — that will matter far more than it appears to at first. Treat it with care that others around you will find excessive. They will not be right.`,
    `Within 90 days, a decision you have been framing as a choice between safety and risk will reveal itself to be a choice between two different kinds of risk. Choose the one that scares you for the right reasons.`,
    `${name}, a conversation is coming that will change the shape of at least one important relationship. You will know it by the way it makes you feel both exposed and, beneath that, relieved.`,
    `Something is ending in your life, ${name} — gracefully or otherwise. The ending has been necessary for longer than you have been willing to admit. On the other side of it is something that could not have begun until this was complete.`,
    `The next significant moment in your path involves a choice between being seen and being safe. The stars say you have chosen safe more often than has been good for you. The next opportunity to choose differently is close.`,
    `An unexpected source of support — practical, emotional, or financial — will reveal itself in the coming weeks. It will not come from where you have been looking. Allow it without immediately questioning your worthiness of it.`,
    `A creative or intellectual project you have been treating as a side interest is about to demand more of your attention. The lines say this is not a distraction from your path. It is your path, approaching from an angle you did not expect.`,
    `${name}, something you said or created or put into the world will reach someone who needed it more than you knew. The ripple is already moving. You will hear about it — or feel it — within the next cycle.`,
    `A period of solitude — chosen or imposed — is approaching. The lines say this is not abandonment or failure. It is the specific condition required for the next version of you to take shape. Do not fight it.`,
    `An authority figure or gatekeeper in your life is about to change their position — toward you, or out of your path entirely. Either way, something that required their approval will no longer require it.`,
    `The recurring thought you have been dismissing as fantasy is not fantasy. It is directional intelligence. The next 90 days will offer at least one concrete opportunity to test it. Do not let it pass unlabelled.`,
    `${name}, a reconciliation — with a person, with an idea, with a version of yourself — is available in the coming months. Whether you take it is yours to decide. The lines say only that the door will be open. It will not remain open.`,
    `Something in your physical environment — where you live, where you work, how you move through space — is about to change. The change will feel disruptive at the time. Looking back, you will understand it as the rearrangement that made everything else possible.`,
    `A skill or quality you have been developing quietly, without announcing it, is about to become relevant in a way that surprises even you. The private labour was not invisible to the universe. It is about to be called upon.`,
  ];
  const WARNINGS = [
  ...
  const TEASERS = [
    ...
    `${name}, I have read many palms. What I see in yours is unusual — not in a comfortable way. The lines carry the specific signature of a life about to change in ways you have not yet permitted yourself to fully imagine. What I can share freely is only a fraction of what the full reading holds.`,
    `The marks on your hand tell a story that begins long before this life and extends far beyond what is visible from where you are standing. ${name}, the convergence I see in your lines happens rarely — and when it does, it always precedes something significant. I have only begun to read it.`,
    `${name}, there are people who come to me and the lines say very little. Then there are people like you — where every mark is vivid, layered, insistent. Your palm is asking to be read fully. What I have shown you here is the opening of something considerably longer.`,
    `What I see in your palm, ${name}, I was not entirely expecting. The combination of lines you carry does not appear often. I have given you the outline. The full picture is far more specific, and considerably more urgent.`,
    `${name}, the lines of your palm carry an energy I can only describe as unresolved — in the way that an unfinished sentence carries more weight than a completed one. Something in your life is reaching for a conclusion it has not yet found. The full reading makes clear what that is.`,
    `I need you to understand something, ${name}: what I have shared so far is the version of your reading that requires no courage to receive. The rest — encoded more deeply in your lines — is the part that will matter. The part that, once heard, you will not be able to unfeel.`,
    `Your palm speaks in a voice I do not often encounter, ${name}. There are layers here that a single glance cannot surface — a past that explains a present you have been struggling to understand, and a future closer and more specific than what I have described.`,
    `${name}, the surface of your palm tells one story. Below the surface, in the depth and quality of the lines themselves, there is another story entirely. The one beneath is older, stranger, and considerably more illuminating. What I have shown you is the prologue.`,
    `There is something particular about your palm, ${name} — a marking I noticed immediately and have been deciding how to name. It speaks of a crossroads approaching on a specific timeline. The full reading tells you what I see there.`,
    `${name}, I have been reading palms long enough to know when a hand is asking for something more than a surface reading. Yours is. The lines are precise, specific, and — in places — urgent. What cannot be said briefly is what matters most.`,
    `The line of your fate, ${name}, carries within it the evidence of a life that has already pivoted more than once and is preparing to pivot again. I can see the shape of what is coming. The full reading names it directly.`,
  ];
  ...
  // Future events rotate every 90 days — same person gets a new prediction each cycle
  const daysSinceEpoch = Math.floor(Date.now() / (1000 * 60 * 60 * 24));
  const period90       = Math.floor(daysSinceEpoch / 90);
  const futureRng      = seededRandom((seed ^ (period90 * 2654435761)) >>> 0);
  ...
  const futureRng2     = seededRandom((seed ^ (period90 * 2654435761) ^ 0xDEADBEEF) >>> 0);
...
This is not chance that brought you here, ${name}. The lines of your palm carry a specific frequency — a signature that marks you as someone standing at the beginning of something the rest of your life will be shaped by. The question the stars are asking you is not whether the change is coming. It is whether you will step toward it deliberately, or wait for it to arrive and find you unprepared.`;
  ...
  return {
    ...
    lifeLine: love, heartLine: love, headLine: career, fateLine: futureEvent,
  };
}
    ...
    <div style={{paddingTop:40,paddingBottom:60,animation:"fadeUp 0.6s ease both"}}>
      ...
      <div style={{textAlign:"center",marginBottom:28}}>
        ...
        <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:20,color:C.cream,margin:0,lineHeight:1.6,opacity:0.92}}>
          Madame Seraphina requires your details<br/>in order to read your fortune
        </p>
      </div>
  ...
  useEffect(() => {
    ...
    img.onload = () => {
      ...
      (async () => {
        ...
        setMsg("Transmitting to Madame Seraphina…");
        for (let i = 0; i <= 62; i++) {
          const t = i / 62;
          ctx.clearRect(0, 0, W, H);
          ctx.drawImage(greyMidCanvas, 0, 0);
...
Respond ONLY with valid JSON, no markdown: {"greeting":"dramatic 1-sentence max 18 words","teaser":"2-3 sentence teaser with hook","lifeLine":"2 vivid sentences","heartLine":"2 vivid sentences","headLine":"2 vivid sentences","fateLine":"2 vivid sentences","fullReading":"4 paragraphs with \\n\\n","luckyNumber":"1-9","luckyColor":"evocative colour","soulSign":"mystical archetype 2-4 words","warning":"one ominous sentence","gift":"one sentence","pastLife":"one past life hint","nearFuture":"one 90-day prediction"}`;
    ...
    return(<p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:20,color:C.cream,lineHeight:1.95,margin:0,minHeight:70}}>{shown}<span style={{opacity:done?0:1,animation:"blink 1s infinite",color:C.gold}}>|</span></p>);
  };
          ...
          <div style={{paddingTop:28,paddingBottom:80,animation:"fadeUp 0.6s ease both"}}>
            ...
            <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12}}>
              ...
              {(()=>{
                ...
                // Monthly seed: combine user seed + current month + year
                ...
                const MONTHLY_NUMS = ["1","2","3","4","5","6","7","8","9"];
                const mSign   = MONTHLY_SIGNS[Math.floor(mRng() * MONTHLY_SIGNS.length)];
                const mColor  = MONTHLY_COLORS[Math.floor(mRng() * MONTHLY_COLORS.length)];
                const mNum    = MONTHLY_NUMS[Math.floor(mRng() * MONTHLY_NUMS.length)];
                return (
                  <>
                    <div style={{background:C.surface,border:`1px solid ${C.gold}44`,borderRadius:14,padding:"16px",marginBottom:12,position:"relative",overflow:"hidden"}}>
                      ...
                      <div style={{textAlign:"center",marginBottom:12}}>
                        <span style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.gold,letterSpacing:3,textTransform:"uppercase"}}>
                          ✦ {MONTHS_LBL[curMonth]} Elements ✦
                        </span>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.goldDim,letterSpacing:2,textTransform:"uppercase",marginBottom:6}}>🌅 Today's Fortune</div>
                  {(()=>{
  ...
  const DAILY_FORTUNES = [
    `The universe conspires in your favour today, ${n} — but only if you take the first step. Something you have been waiting for permission to begin needs no permission but your own.`,
    `Today carries an unusual momentum, ${n}. The action you have been postponing is precisely the one the universe is waiting for you to take.`,
    `A door that has been closed for some time is looser on its hinges today, ${n}. A gentle push is all it requires.`,
    `The stars have cleared a path for you today, ${n}. The obstacle you were preparing to navigate has moved. Walk forward without waiting for confirmation.`,
    `Today is not a day for planning, ${n}. It is a day for doing the thing the plan has been delaying.`,
    `Something small you do today, ${n}, will have a disproportionately large effect. The universe is amplifying your signal — make sure it is the one you intend to send.`,
    `The hesitation you have been feeling is not intuition warning you away, ${n}. It is habit. Today, act before the habit speaks.`,
    `Today brings a narrow window, ${n}. Not an emergency — just an alignment of conditions that will not last long. Move when you feel the pull, not after you have reasoned yourself out of it.`,
    `The energy today favours beginnings, ${n}. Whatever you start before the sun is high will carry further than what you start after.`,
    `A conversation you have been avoiding will be easier today than it will be tomorrow, ${n}. The longer you wait, the heavier it becomes.`,
    `Pay attention to what you notice first today, ${n}. The universe leaves its most important messages where your eyes land before your mind has time to filter.`,
    `Something you have been looking at without seeing will become clear today, ${n}. The understanding arrives on its own schedule. Do not force it — simply remain open.`,
    `The person you encounter unexpectedly today, ${n}, is not a coincidence. Give them more than the attention you would usually spare.`,
    `Today asks you to listen more than you speak, ${n}. The information you need is already in the room. It is waiting for you to be quiet enough to hear it.`,
    `There is a detail in your current situation that you have been overlooking, ${n}. Today it will make itself obvious. When it does, trust what it tells you.`,
    `The thing you keep almost-noticing but then moving past — today is the day to stop and look at it properly, ${n}.`,
    `Something in your peripheral vision — a person, an idea, an opportunity — deserves your full attention today, ${n}. Turn and face it.`,
    `Today the universe speaks quietly, ${n}. If you are moving too fast, you will miss it. Slow down by ten percent and you will hear everything.`,
    `A pattern you have been living inside without seeing will reveal itself today, ${n}. Once you see it, you cannot unsee it. The seeing is the gift.`,
    `The answer you have been seeking is closer than you have been looking, ${n}. Today, check the obvious places before the complicated ones.`,
    `Someone in your life needs to hear something from you today, ${n} — not advice, just acknowledgement. The words are simpler than you think.`,
    `Today brings an opportunity to repair something small before it becomes something large, ${n}. The moment is brief but real.`,
    `The person you think least about today, ${n}, may be thinking most about you. A small gesture of contact will mean more than you expect.`,
    `Today asks you to be the one who reaches out first, ${n}. The pride that has been keeping you waiting is costing you more than the reaching would.`,
    `A connection you dismissed as insignificant carries more weight than you assigned it, ${n}. Today something will happen to remind you why.`,
    `The conversation you most need to have today is the one you are most likely to avoid, ${n}. The universe will offer you the opening. Take it.`,
    `Someone around you today is carrying something heavier than it looks, ${n}. Your awareness of this — even unspoken — is itself a form of care.`,
    `Today bring you a chance to be seen more clearly by someone who matters, ${n}. Let them.`,
    `The loneliness you have been carrying quietly, ${n}, is not invisible to everyone. Today someone will see it. Allow them to respond.`,
    `A boundary that has needed stating, ${n}, will be easier to name today than on any other day this week. Say the thing clearly. You do not have to explain it.`,
    `The version of you that is afraid and the version that is ready are both telling the truth today, ${n}. You do not have to choose between them — just let the ready one go first.`,
    `Today is a good day to forgive yourself for something old, ${n}. The weight of it has been costing you more than the thing was worth.`,
    `Something you have been telling yourself as fact is actually a story, ${n}. Today you will have the chance to notice the difference.`,
    `The standards you hold yourself to were set a long time ago, ${n}, and may no longer fit who you have become. Today, question one of them.`,
    `Today brings the quiet that precedes change, ${n}. Resist the urge to fill it. What is coming needs the space.`,
    `The version of yourself you have been afraid to become, ${n}, is becoming you anyway. Today you will feel it move a step closer.`,
    `Today ask yourself what you would do if you were not trying to manage how you appear, ${n}. Then consider doing that.`,
    `The feeling you have been naming as anxiety today may actually be anticipation, ${n}. The body uses the same signal for both. Try on the second interpretation.`,
    `A habit that no longer serves you will show itself clearly today, ${n}. You do not have to act on the seeing immediately — but see it fully.`,
    `Today is a day for honesty with yourself before honesty with anyone else, ${n}. The inner conversation is overdue.`,
    `An idea that has been forming below the surface will break through today, ${n}. Have something nearby to catch it.`,
    `Today is not for refining what already exists, ${n}. It is for beginning something that does not yet have a shape.`,
    `The creative impulse you have been explaining away, ${n}, is not a distraction from your real work. It is your real work, announcing itself.`,
    `Something you make or write or say today, ${n}, will reach someone who needed it more than you knew. Make it anyway.`,
    `The project you have been keeping private is ready to be seen, ${n}. Not finished — ready to be seen. There is a difference.`,
    `Today brings the specific energy that your most stalled project needs, ${n}. Give it one hour of your full attention.`,
    `An unconventional approach that you have been dismissing as impractical is exactly what the current problem requires, ${n}. Give it one serious attempt.`,
    `The blank page has been waiting for you, ${n}. Today the first line comes easily. Begin before you plan the second.`,
    `Something you built or created in the past is ready to be revisited, ${n}. Not to fix it — to see how far you have come.`,
    `Today the muse is not waiting to be invited, ${n}. She is already at the door. Open it before you are ready.`,
    `What appears to be stagnation today, ${n}, is actually consolidation. The roots grow before the new branch does.`,
    `The timeline you have assigned to this is wrong, ${n}. Not in a discouraging way. In the way that means more time is on your side than you know.`,
    `Today asks for patience of the active kind, ${n} — not waiting, but preparing without needing the moment to have arrived.`,
    `Something is resolving beneath the surface today, ${n}. You will not see it yet. Trust the process the same way you trust that a seed knows what it is doing.`,
    `The outcome you have been anxious about is already moving toward the version you need, ${n}. Your interference today would slow it. Rest.`,
    `Today is a day for trust, ${n}. Not blind trust — earned trust, based on how many times the thing you feared did not arrive.`,
    `The universe is sorting something out on your behalf today, ${n}. The wisest thing you can do is stay out of its way.`,
    `Things are taking longer than you planned, ${n}. This is not failure. This is the universe being more careful with you than you are being with yourself.`,
    `The delay you are experiencing today, ${n}, is protecting you from something you cannot yet see. The protection will become obvious later.`,
    `Today asks you to do less and trust more, ${n}. The doing has been done. Now comes the part where you allow.`,
    `The risk that has been living in your thoughts without making it to your actions, ${n} — today the distance between thought and action is shorter than usual.`,
    `Today is a day to say yes to the thing you have been almost saying yes to, ${n}. The conditions will not be more favourable next week.`,
    `The courage required for what you are considering, ${n}, is less than you have calculated. You have done harder things with less certainty.`,
    `What you are afraid of losing by taking the risk, ${n}, you are already losing by not taking it. Today is a good day to do the arithmetic on that.`,
    `Today the universe asks you to be a little braver than feels comfortable, ${n}. Not reckless — just slightly beyond the edge of what feels safe.`,
    `The leap you have been calculating, ${n}, does not require more calculation. It requires more leap.`,
    `Today brings a specific kind of courage: the kind that is afraid and moves anyway, ${n}. You know the feeling. You have been here before.`,
    `Something you have been calling realistic, ${n}, is actually fear with good PR. Today, test that assumption.`,
    `The worst-case scenario you have been preparing for, ${n}, is unlikely. Today is a good day to act from the probable, not the catastrophic.`,
    `Today the universe clears its throat and looks at you, ${n}. You know what it is asking. You have known for a while.`,
    `Today is a day for receiving, ${n} — not for earning, proving, or justifying. Simply allow the good that is trying to reach you.`,
    `Something is trying to come to you today, ${n}, and your instinct will be to manage it, minimise it, or redirect it to someone more deserving. Do not. Receive it.`,
    `The help being offered today is real, ${n}. It does not diminish you to accept it. Taking it gracefully is its own form of strength.`,
    `An unexpected kindness will arrive today, ${n}. Your job is not to earn it retroactively or explain it away. Your job is to let it mean something.`,
    `Today brings a small form of abundance, ${n} — not necessarily material, but real. Notice it when it arrives. Name it to yourself.`,
    `The universe is saying yes to something today, ${n}. Make sure you are saying yes back.`,
    `Today is a day to stop apologising for needing things, ${n}. You are allowed to want what you want without a disclaimer.`,
    `Something you asked for, formally or quietly, is arriving today, ${n}. It may look different than you imagined. It is still the answer.`,
    `Today the energy favours those who ask, ${n}. The door that would normally stay closed will open if you knock. Knock.`,
    `Today is not a day for more effort, ${n}. It is a day for receiving the return on the effort that has already been made.`,
    `Something in your life is completing its cycle today, ${n}. Honour it for what it was before you release it for what comes next.`,
    `The grief you have been carrying, ${n}, is allowed to be smaller today. You do not have to carry all of it every day.`,
    `Today the universe offers you permission to put something down, ${n}. You have been holding it long enough. The ground will hold it now.`,
    `An ending you have been resisting, ${n}, is more complete than you have allowed yourself to acknowledge. Today, acknowledge it.`,
    `The space left by what ended, ${n}, is not emptiness. It is capacity. Today you will feel the difference.`,
    `What you are mourning today, ${n}, was real and worth mourning. Grieve it completely. The other side of complete grief is freedom.`,
    `Today is a day to let one thing go, ${n} — one small thing you have been carrying past its usefulness. You will feel lighter immediately.`,
    `The chapter that has been closing slowly, ${n}, closes today. Not dramatically. Just finally.`,
    `Something you have been grieving, ${n}, is teaching you something you will eventually be grateful for. You are not there yet. But you are closer than yesterday.`,
    `Today the universe reminds you, ${n}, that what you lost made room for what is coming. The room is almost ready.`,
    `Today brings a moment of unusual clarity about why you are here, ${n}. It will not arrive with trumpets. It will arrive quietly, between two ordinary things.`,
    `The work that feels most like you, ${n}, is the work the world most needs from you. Today, do more of that.`,
    `Something you do today without being asked, without recognition, and without guarantee will be among the most important things you have ever done, ${n}.`,
    `Today ask yourself not what you want to have, ${n}, but what you want to have been. The answer will reorder your priorities.`,
    `The contribution you have been undervaluing, ${n}, is not small. Today someone will show you its size.`,
    `Today the thread of your purpose becomes visible again, ${n}. You may have lost sight of it in the recent noise. It was not lost — you were.`,
    `What you are drawn to when nothing is required of you, ${n}, is pointing somewhere important. Today, follow it further than usual.`,
    `The impact you are having, ${n}, is larger and more specific than you know. Today, act as though that is true.`,
    `Today is a day to remember why you started, ${n}, before the distance from the beginning made the reason seem small.`,
    `Something you do naturally, ${n}, is miraculous to someone else. Today that person will find you, or you will find them.`,
    `Today your body is asking for something specific, ${n}. Not what you usually give it — something else. Listen before you override.`,
    `The rest you have been deferring, ${n}, is not a luxury today. It is the foundation that everything else requires. Take it without guilt.`,
    `Today is a good day to move, ${n} — not to achieve something, but to remind yourself that you are alive in a body that works. Move for the joy of it.`,
    `Something in your physical environment is affecting your inner life, ${n}. Today, identify it and change one thing.`,
    `The tension you have been carrying in your body, ${n}, has a location. Today, find it and breathe directly into it.`,
    `Today your energy is an asset, ${n}. Spend it on the things that refill it as well as use it. Avoid the things that only deplete.`,
    `The sleep you have been shortchanging yourself, ${n}, is owed to you. Consider today the day you begin repaying the debt.`,
    `Something simple will restore you today, ${n} — a walk, a meal made slowly, an hour with no agenda. Do not skip it in favour of productivity.`,
    `Your nervous system is asking for stillness today, ${n}. Even ten minutes of it will change the texture of the rest of your day.`,
    `Today the connection between how you treat your body and how clearly you think will be unusually obvious, ${n}. Pay attention to it.`,
    `Today is not the day for large financial decisions, ${n}, but it is an excellent day for clarity about the small ones that have been adding up.`,
    `The resource you have been hoarding out of fear, ${n}, is losing value in storage. Today, consider putting it to work.`,
    `Something you dismissed as financially impractical deserves a second look today, ${n}. The numbers may have changed.`,
    `Today a small unexpected financial shift arrives, ${n}. Treat it as a signal about direction, not just an event.`,
    `The conversation about money you have been avoiding, ${n}, will be simpler than you fear if you begin it today.`,
    `Today is a day to be generous in a small way, ${n}. The return will not be financial, but it will be real.`,
    `The financial decision you made in the past that you are still judging yourself for, ${n} — today is a good day to release the judgment. You knew what you knew.`,
    `Something about your relationship with money, ${n}, is ready to change. Today you will notice the edge of that change.`,
    `Today the universe sends a small financial gift in an unexpected form, ${n}. It may not look like money. Recognise it anyway.`,
    `The abundance available to you, ${n}, is blocked by something you believe rather than something that is true. Today, test one of those beliefs.`,
    `This is a significant day in a longer cycle, ${n}. You will not necessarily know it while it is happening. That is fine. It is significant anyway.`,
    `Today marks a turning point so subtle it is almost invisible, ${n}. The direction has changed. The speed has not yet followed.`,
    `The cycle you have been in, ${n}, is ending — not dramatically, not all at once, but ending. Today is part of the completion.`,
    `Today you stand between what has been and what is coming, ${n}. It is an uncomfortable place and also a sacred one.`,
    `A new cycle begins today, ${n}, whether or not you have fully closed the previous one. Both things can be true simultaneously.`,
    `Today is an echo of a day from your past, ${n} — similar conditions, similar choice. This time you know more. Use it.`,
    `The season of difficulty you have been moving through, ${n}, is not permanent. Today marks the first day of its end.`,
    `Today closes something that should have closed earlier, ${n}. Late closings are still closings. Be grateful it is finally here.`,
    `The timing today is better than it appears, ${n}. What looks like an ordinary day is the specific day the universe chose for this.`,
    `Today is later in the story than you think, ${n}. You are further along than the difficulty of the recent days suggests.`,
    `Something will surprise you today, ${n} — pleasantly. Let it.`,
    `The unexpected arrival today, ${n}, is not an interruption. It is the main event.`,
    `Today brings something the rational mind could not have predicted, ${n}. Receive it without immediately trying to explain it.`,
    `A coincidence today is not a coincidence, ${n}. The universe is not subtle about this one.`,
    `Today delivers an answer to a question you forgot you asked, ${n}. When it arrives, you will remember the asking.`,
    `Something today will make you laugh when you expected it to make you cry, ${n}. Allow the relief of the laughter.`,
    `Today an old thread reappears, ${n} — something from your past that still has life in it. Meet it without the assumptions you took into it last time.`,
    `The disruption today, ${n}, is not against you. It is for you. The reordering it causes is necessary.`,
    `Today brings a message in an unusual form, ${n}. A song lyric, an overheard sentence, a dream remembered suddenly — whatever catches you off guard is worth your attention.`,
    `Something you have been waiting for will arrive today in a form so different from what you imagined, ${n}, that you will almost miss it. Almost.`,
    `Today is a day for thinking, not just doing, ${n}. The quality of your reflection will determine the quality of what follows.`,
    `The lesson you have been in the middle of learning, ${n}, is closer to complete than it feels. Today you will understand more of it.`,
    `Today brings a moment of genuine wisdom, ${n} — the earned kind, not the inherited kind. It will feel like remembering rather than learning.`,
    `Something you dismissed as obvious is worth a second look today, ${n}. The obvious things are obvious precisely because they are true.`,
    `Today the perspective you need is available if you are willing to look from someone else's position, ${n}. Choose the person whose view of you is most generous.`,
    `The question worth sitting with today, ${n}: what would you do if you already trusted yourself? Then do that.`,
    `Today is a day to question one assumption you have been treating as a fact, ${n}. Pick the one that is costing you the most.`,
    `The understanding you have been seeking, ${n}, is already within you. Today a prompt from the outside world will help you locate it.`,
    `Today brings rare clarity about a long-standing confusion, ${n}. When it arrives, write it down. Clarity is perishable.`,
    `Something you have known for a long time without acting on, ${n}, asks to be acted on today. The knowing is complete. It is time for the doing.`,
  ];
                  const todayFortune = DAILY_FORTUNES[Math.floor(dRng() * DAILY_FORTUNES.length)];
                  return <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:"0 0 8px",lineHeight:1.85}}>{`"${todayFortune}"`}</p>;
                })()}
            ...
            {activeTab==="reading"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:10,position:"relative",overflow:"hidden"}}>
                  <div style={{position:"absolute",top:0,left:0,right:0,height:1.5,background:`linear-gradient(90deg,transparent,${C.gold},transparent)`}}/>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:17,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10}}>{`✦ Reading for ${userName||"You"} ✦`}</div>
                  <TeaserText/>
                </div>
                <div style={{width:"100%",marginBottom:10}}>
                  <div onMouseEnter={()=>setMood("warning")} onMouseLeave={()=>setMood("neutral")} style={{width:"100%",boxSizing:"border-box",background:"rgba(65,8,22,0.35)",border:`1px solid ${C.roseDim}`,borderRadius:11,padding:"14px",marginBottom:10}}>
                    ...
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.7}}>{reading.warning}</p>
                  </div>
                  <div onMouseEnter={()=>setMood("gift")} onMouseLeave={()=>setMood("neutral")} style={{width:"100%",boxSizing:"border-box",background:"rgba(15,50,38,0.35)",border:`1px solid rgba(35,100,65,0.4)`,borderRadius:11,padding:"14px"}}>
                    ...
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.7}}>{reading.gift}</p>
                  </div>
                </div>
                {reading.nearFuture&&(
                  <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:11,padding:"12px 13px",marginBottom:10}}>
                    ...
                    <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.85}}>{reading.nearFuture}</p>
                  </div>
                )}
                {!paid&&!subscribed&&(
                    ...
                    <div style={{background:C.surface,border:`1px solid ${C.gold}2a`,borderRadius:14,padding:"16px",marginBottom:10}}>
                      ...
                      {reading.pastLife&&(
                        <div style={{background:"rgba(50,15,70,0.3)",border:`1px solid rgba(110,35,130,0.3)`,borderRadius:9,padding:"10px 11px",marginBottom:12}}>
                          ...
                          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.8}}>{reading.pastLife}</p>
                        </div>
                      )}
                      {[["💗 Heart Line",reading.heartLine],["🧠 Head Line",reading.headLine],["✋ Life Line",reading.lifeLine],["⭐ Fate Line",reading.fateLine]].map(([title,text])=>(
                        <div key={title} style={{marginBottom:12,paddingBottom:12,borderBottom:`1px solid ${C.border}`}}>
                          ...
                          <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.85}}>{text}</p>
                        </div>
                      ))}
                      <Divider/>
                      ...
                      {(reading.fullReading||"").split("\n\n").map((para,i)=>(
                        <p key={i} style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:21,color:C.cream,lineHeight:1.95,margin:"0 0 14px"}}>{para}</p>
                      ))}
                    </div>
                  </div>
                )}
                ...
                {[["💗 Heart Line",reading.heartLine,C.rose],["🧠 Head Line",reading.headLine,"#6070d8"],["✋ Life Line",reading.lifeLine,C.teal],["⭐ Fate Line",reading.fateLine,C.gold]].map(([title,text,color])=>(
                  <div key={title} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8,borderLeft:`3px solid ${color}`}}>
                    ...
                    {(paid||subscribed)?
                      <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:0,lineHeight:1.85}}>{text}</p>:
                      <div>
                        <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",fontSize:21,color:C.cream,margin:"0 0 6px"}}>{(text||"").slice(0,70)}…</p>

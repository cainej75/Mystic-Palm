  ...
  return (
    <div style={{position:"fixed",inset:0,background:"linear-gradient(160deg,rgba(8,3,20,0.98) 0%,rgba(40,8,25,0.98) 50%,rgba(8,3,20,0.98) 100%)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"20px",zIndex:1000}}>
      ...
      <div ref={shareCardRef} style={{maxWidth:420,width:"100%",background:C.bg,border:`3px solid ${C.gold}`,borderRadius:20,padding:"24px 20px",boxShadow:`0 0 40px rgba(201,168,76,0.3)`,animation:"slideUp 0.5s ease"}}>
        ...
        {/* Person's Name as main content */}
        <div style={{marginBottom:20,paddingBottom:16,borderBottom:`1px solid ${C.gold}44`,textAlign:"center"}}>
          <div style={{fontFamily:"Crimson Text,serif",fontSize:22,color:C.gold,fontStyle:"italic",marginBottom:12}}>{userName}</div>
          <p style={{fontFamily:"Crimson Text,serif",fontSize:16,color:C.cream,lineHeight:1.8,margin:0,fontStyle:"italic"}}>
            {reading.teaser}
          </p>
        </div>
          ...
          return (
            <div style={{marginBottom:20,paddingBottom:16,borderBottom:`1px solid ${C.gold}44`}}>
              <div style={{textAlign:"center",marginBottom:10}}>
                <span style={{fontFamily:"Cinzel,serif",fontSize:11,color:C.gold,letterSpacing:2,textTransform:"uppercase"}}>✦ {MONTHS_LBL[curMonth]} Elements ✦</span>
              </div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:6}}>
                {[["🌙",mSign,"Soul Sign"],["🔢",mNum,"Lucky #"],["🎨",mColor,"Colour"]].map(([ic,v,l])=>(
                  <div key={l} style={{background:"rgba(255,255,255,0.04)",border:`1px solid ${C.gold}22`,borderRadius:8,padding:"8px 5px",textAlign:"center"}}>
                    <div style={{fontSize:18,marginBottom:2}}>{ic}</div>
                    <div style={{fontFamily:"IM Fell English,serif",fontSize:11,color:"#f0dfc0",lineHeight:1.3,fontWeight:500}}>{v}</div>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:7,color:C.cream,letterSpacing:1,marginTop:2,opacity:0.85}}>{l}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div style={{textAlign:"center"}}>
          <a href="https://mysticfortunes.ai" style={{fontFamily:"Cinzel,serif",fontSize:10,color:C.gold,textDecoration:"none",letterSpacing:1,transition:"all 0.3s"}}>
            🔮 MysticFortunes.ai
          </a>
        </div>
      </div>
    ...
    <div style={{paddingTop:40,paddingBottom:60,animation:"fadeUp 0.6s ease both"}}>
      ...
      <div style={{textAlign:"center",marginBottom:28}}>
        ...
        <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:20,color:C.cream,margin:0,lineHeight:1.6,opacity:0.92}}>
          Madame Seraphina requires your details<br/>in order to see your future
        </p>
      </div>
            ...
            */}
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:10,position:"relative",overflow:"hidden"}}>
                  ...
                  {(()=>{
                    ...
                    const DF = [
                      ...
                      `Something small you do today, ${n}, will have a disproportionately large effect. The universe is amplifying your signal.`,
                      `The hesitation you have been feeling is not intuition warning you away, ${n}. It is habit. Today, act before the habit speaks.`,
                      `Today brings a narrow window, ${n}. Move when you feel the pull, not after you have reasoned yourself out of it.`,
                      `The energy today favours beginnings, ${n}. Whatever you start carries further than what you start later.`,
                      `A conversation you have been avoiding will be easier today than tomorrow, ${n}. The longer you wait, the heavier it becomes.`,
                      `Pay attention to what you notice first today, ${n}. The universe leaves its most important messages where your eyes land before your mind filters.`,
                      `Something you have been looking at without seeing will become clear today, ${n}. The understanding arrives on its own schedule.`,
                      ...
                      `Today asks you to listen more than you speak, ${n}. The information you need is already in the room.`,
                      `There is a detail in your current situation that you have been overlooking, ${n}. Today it will make itself obvious.`,
                      `Someone in your life needs to hear something from you today, ${n} — not advice, just acknowledgement.`,
                      `Today brings an opportunity to repair something small before it becomes something large, ${n}.`,
                      `The person you think least about today, ${n}, may be thinking most about you. A small gesture will mean more than you expect.`,
                      `Today ask you to be the one who reaches out first, ${n}. The pride keeping you waiting is costing more than the reaching would.`,
                      `The version of you that is afraid and the version that is ready are both telling the truth today, ${n}. Let the ready one go first.`,
                      ...
                      `The creative impulse you have been explaining away, ${n}, is not a distraction from your real work. It is your real work.`,
                      `What appears to be stagnation today, ${n}, is actually consolidation. The roots grow before the new branch does.`,
                      `The timeline you have assigned to this is wrong, ${n}. More time is on your side than you know.`,
                      `Today asks for patience of the active kind, ${n} — not waiting, but preparing without needing the moment to have arrived.`,
                      `The risk that has been living in your thoughts without making it to your actions, ${n} — today the distance is shorter than usual.`,
                      ...
                      `An unexpected kindness will arrive today, ${n}. Your job is not to earn it retroactively. Let it mean something.`,
                      `Something in your life is completing its cycle today, ${n}. Honour it for what it was before you release it.`,
                      `The grief you have been carrying, ${n}, is allowed to be smaller today. You do not have to carry all of it every day.`,
                      `Today brings a moment of unusual clarity about why you are here, ${n}. It will arrive quietly, between two ordinary things.`,
                      `Something you do today without being asked, ${n}, will be among the most important things you have ever done.`,
                      `Today your body is asking for something specific, ${n}. Listen before you override.`,
                      `The rest you have been deferring, ${n}, is not a luxury today. It is the foundation everything else requires.`,
                      `This is a significant day in a longer cycle, ${n}. You will not necessarily know it while it is happening.`,
                      `The unexpected arrival today, ${n}, is not an interruption. It is the main event.`,
                      `Today brings a message in an unusual form, ${n}. Whatever catches you off guard is worth your attention.`,
                      ...
                      `Today the universe says yes to something, ${n}. Make sure you are saying yes back.`,
                    ];
                ...
                {!paid&&!subscribed&&(
                  <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",marginBottom:10,textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                    ...
                    <p style={{fontFamily:"Cinzel,serif",color:"#c090ff",fontSize:14,lineHeight:1.7,margin:"0 0 10px",fontWeight:500,letterSpacing:0.5}}>Full palm analysis · Past life echo · The next 90 days · Complete mystical narrative · Fate line reading</p>
                ...
                {(paid||subscribed)&&(
                  <div style={{animation:"fadeUp 0.6s ease both"}}>
                    <div style={{background:C.surface,border:`1px solid ${C.gold}2a`,borderRadius:14,padding:"16px",marginBottom:10}}>
                      ...
                      <Divider/>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:13,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10,textAlign:"center",color:C.gold}}>✦ Madame Seraphina Speaks ✦</div>
            ...
            {activeTab==="lines"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                  ...
                  <div key={title} style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8,borderLeft:`3px solid ${color}`}}>
                    ...
                    {(paid||subscribed)?
                      ...
                      <div>
                        ...
                        <button className="ghost-btn" onClick={()=>setPaid(true)} style={{fontSize:13,padding:"4px 12px",borderRadius:18}}>🔮 Unlock — $2.99</button>
                      </div>
                    }
                  </div>
                ))}
                {/* Next 90 Days — paywalled */}
                ...
                {/* Madame Seraphina Speaks — paywalled */}
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"13px",marginBottom:8}}>
            ...
            {activeTab==="extras"&&(
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:14,padding:"16px",marginBottom:16}}>
                  <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.gold,letterSpacing:2,textTransform:"uppercase",marginBottom:10,textAlign:"center"}}>{userName}</div>
                  <p style={{fontFamily:"Crimson Text,serif",fontSize:17,color:C.cream,lineHeight:1.7,margin:0,fontStyle:"italic",textAlign:"center"}}>
                    {reading.teaser}
                  </p>
                </div>
                {(()=>{

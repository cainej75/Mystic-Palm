...
function generatePartnerCompatibility(name1, dob1, name2, dob2) {
  ...
  const INSIGHTS = [
    ...
    "Your compatibility is not about similarity — it is about perfect complementarity. Where one ends, the other begins. This is the architecture of a lasting union.",
    "The compatibility between you has a quality of ease that only comes when two people have genuinely met their match. The stars smile on this.",
    "What the lines reveal is this: you challenge each other in exactly the ways you both need to grow. This is not an easy love — it is a necessary one.",
    "You were not meant to be comfortable together — you were meant to become your fullest selves together. This is the deepest form of love.",
    "The universe has woven your destinies together. What you share transcends the ordinary — a recognition of something ancient that only you two understand.",
    "There is a quality of recognition in this bond. You see each other — not the versions you show the world, but the truth beneath. This sight is rare.",
    "The passion between you is not gentle — it is transformative. You will not be the same people by the time you are done loving each other.",
    "The lines speak of a union built on genuine trust rather than romantic illusion. You can be fully yourself with each other. This is more valuable than passion alone.",
    "Your compatibility is written in the convergence of your energies. Together you create something neither of you could build alone. This is the definition of sacred partnership.",
    "This is not a relationship of comfort — it is a relationship of purpose. The universe has given you each other as instruments of each other's becoming.",
    "What exists between you is a bond forged through understanding rather than assumption. You have learned to read each other in ways most couples never achieve.",
    "The lines show two people who have chosen each other repeatedly, in small ways and large. This is not destiny — this is deliberate, conscious love.",
    "The challenges you face together are not obstacles — they are the curriculum of your deepening. Your connection is being forged in fire, and it will be unbreakable.",
    "You have found in each other not just a partner, but a witness to your becoming. This is the rarest form of love — the kind that sees who you are becoming and loves that person too.",
    "The convergence of your souls speaks of a love that was written across lifetimes. You are each other's homecoming, and that is worth everything you will ever sacrifice for it.",
  ];
...
function generateFortune(seed, userName, dob) {
  ...
  const SERAPHINA_WARNINGS = [
    ...
    "There is a shadow running beneath your brightness, ${name}. A fear that if people truly knew you, they would leave. The lines suggest this fear is older than it needs to be.",
    "What the palm reveals is a pattern of choosing familiar pain over unfamiliar growth. You have done this more than once. The universe is asking you to notice this before you choose it again.",
    "The warning I carry from your palm is this: the people you are closest to may not be the people most able to see you. Proximity is not the same as vision.",
    "There is a tendency encoded in your lines, ${name}, to give until giving costs everything. The palm asks: at what point does love become self-erasure?",
  ];
...
const CompatSection = React.memo(function CompatSection({myReading}) {
  ...
  const go=async()=>{
    ...
    // Use algorithm-only compatibility reading (no Claude API cost)
    setResult(FB);
    setLoading(false);
  };
...
// ── PALM LINE DESCRIPTION ARRAYS ── (used by getReading at component level)
const PALM_LIFE_LINES = [
  "Your life line is long and deeply etched, marking a vitality that has endured what would break others. You were built to last.",
  "The life line curves with the signature of someone who has reinvented themselves. Not from weakness, but from growth that the previous version could not contain.",
  "The depth of your life line speaks to a person profoundly connected to the physical world. You feel the weight of your own existence more than most.",
  "Your life line shows a person whose energy does not move in a straight line. There are surges and retreats, expansions and consolidations — the pattern of genuine living.",
  "The early part of your life line shows turbulence that the later part does not. Whatever unsettled the beginning has been metabolised into wisdom.",
  "Your life line speaks of longevity earned rather than given. The decisions you make about how you live have more impact on your vitality than you acknowledge.",
  "There is an unusual quality to your life line — a mark of those with a specific purpose that becomes clearer as years accumulate. You will not peak early.",
  ...
  "The life line reveals a constitution that has been underused. There is more capacity in you than your current circumstances are drawing on.",
  "Your life line carries the mark of someone who takes on others' burdens naturally. It has shaped your vitality in ways both beautiful and costly.",
...
const PALM_HEART_LINES = [
  "Your heart line curves with rare depth. You do not love lightly — those who have been loved by you carry it for the rest of their lives.",
  "The heart line reveals someone who loves with totality or not at all. You have learned to protect yourself, but the capacity for devotion remains untouched.",
  "Love for you has never been uncomplicated. Your line shows depth, passion, and the kind of devotion that makes others both envious and afraid.",
  ...
  "Your emotional line tells of someone who has learned to love carefully after learning the cost of loving carelessly. That wisdom is real, but it has cost you.",
  "The line of your heart is deep and unbroken — a rare thing. It speaks of loyalty so profound it has sometimes been mistaken for stubbornness.",
  ...
  "The heart line carries the mark of someone who has given more than they received for longer than was good. This is changing.",
  ...
  "The line reveals a romantic capacity operating below its potential — not from lack of love, but from fear of what full vulnerability would cost.",
...
const PALM_HEAD_LINES = [
  "Your head line runs long and clear — a mind built for strategy and vision that outpaces the structures you have been placed within.",
  "There is a crossroads visible in your thinking. Two paths. One is safe. The other carries risk but also work that makes the safe option feel like a costume.",
  "The head line indicates someone whose greatest challenge has never been ability — it has been authority. The authority to believe what you see is worth building.",
  ...
  "The head and fate lines converge in a pattern I associate with people becoming something the world does not yet have language for. Trust the discomfort.",
  ...
  "The head line speaks of a mind that works best outside the container it has been placed in. The constraints are not permanent features.",
...
const PALM_FATE_LINES = [
  "The fate line climbs strongly, carrying the mark of someone whose direction has been chosen rather than inherited or accidental.",
...
export default function MysticFortunes() {
  ...
  // Memoized handlers for camera components — prevents flickering from inline function recreation
  const handleCameraCapture = useCallback((img, lm) => {
  ...
  const getReading=async()=>{
    console.log("getReading called, palmImage:", !!palmImage);
    if(!palmImage){
      console.warn("getReading: palmImage is null");
      return;
    }
    try {
      ...
      console.log("Step 1 complete: Image compressed");
      
      // Step 1: Validate using MediaPipe Hands
      let palmValid = true;
      try {
        console.log("Step 2: Detecting palm...");
        palmValid = await detectPalm(compressed);
        console.log("Step 2 complete: Palm detection =", palmValid);
      } catch(e) {
        console.warn("Palm detection error:", e);
        // On error, still consider it valid (let through)
      }
      
      if (!palmValid) {
        console.warn("Palm image invalid - showing error");
        setPalmError(true);
        return;
      }
      
      console.log("Step 3: Generating seed...");
      // Step 2: Always generate seed fortune first
      const _seed = generateSeed(userName, birthDate);
      console.log("Seed:", _seed);
      
      console.log("Step 4: Generating fortune...");
      const seedFortune = generateFortune(_seed, userName, birthDate);
      console.log("Fortune generated:", !!seedFortune);

      // Step 3: Use algorithm-only reading (no Claude API cost)
      // Build reading from algorithm-generated values
      // Create separate RNG streams for each palm line so they don't repeat seedFortune values
      console.log("Step 5: Creating RNG streams...");
      const lifeLineRng = seededRandom((_seed ^ 0x12121212) >>> 0);
      const heartLineRng = seededRandom((_seed ^ 0x34343434) >>> 0);
      const headLineRng = seededRandom((_seed ^ 0x56565656) >>> 0);
      const fateLineRng = seededRandom((_seed ^ 0x78787878) >>> 0);
      
      console.log("Step 6: Building reading object...");
      const algorithmReading = {
        greeting: seedFortune.greeting,
        teaser: seedFortune.teaser,
        lifeLine: seededPick(lifeLineRng, PALM_LIFE_LINES),
        heartLine: seededPick(heartLineRng, PALM_HEART_LINES),
        headLine: seededPick(headLineRng, PALM_HEAD_LINES),
        fateLine: seededPick(fateLineRng, PALM_FATE_LINES),
        fullReading: seedFortune.fullReading,
        nearFuture: seedFortune.nearFuture,
        soulSign: seedFortune.soulSign,
        luckyColor: seedFortune.luckyColor,
        luckyNumber: seedFortune.luckyNumber,
        gift: seedFortune.gift,
        warning: seedFortune.warning,
        pastLife: seedFortune.pastLife,
      };
      
      console.log("Step 7: Setting reading and phase...");
      setReading(algorithmReading);
      setPhase("result");
      console.log("✅ SUCCESS: Reading complete, phase set to result");
    } catch(err) {
                ...
                {(fullPaid||subscribed)&&(
                  ...
                  <button
                    onClick={async()=>{
                      ...
                      try{const{generateFullRevelationPDF}=await lazyImportPDFGenerators();await generateFullRevelationPDF(reading,userName,birthDate);setFullPDFSaved(true);}catch(e){}

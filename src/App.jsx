          ...
          <div style={{paddingTop:28,paddingBottom:80,animation:"fadeUp 0.6s ease both"}}>
            ...
            */}
            ...
            <div style={{display:"flex",borderBottom:`1px solid ${C.border}`,marginBottom:12}}>
              {[["reading","📖","Reading"],["lines","✋","Lines"],["extras","🃏","Card"]].map(([id,icon,label])=>(
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                {reading.nearFuture&&(
                  <div style={{background:"linear-gradient(135deg,rgba(25,12,45,0.8),rgba(45,15,28,0.8))",border:`1px solid ${C.gold}2a`,borderRadius:11,padding:"12px 13px",marginBottom:10}}>
                    <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.goldDim,letterSpacing:2,textTransform:"uppercase",marginBottom:4}}>🌟 The Next 90 Days</div>
                    <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:19,color:C.cream,margin:0,lineHeight:1.85}}>{reading.nearFuture}</p>
                  </div>
                )}
                {!paid&&!subscribed&&(
                  <div style={{background:"linear-gradient(135deg,#100616,#0c0812)",border:`1px solid ${C.gold}38`,borderRadius:14,padding:"18px 16px",marginBottom:10,textAlign:"center",animation:"orbGlow 4s ease-in-out infinite"}}>
                    ...
                    <h3 style={{fontFamily:"Cinzel,serif",fontSize:18,color:C.gold,margin:"0 0 6px"}}>The Full Revelation Awaits</h3>
                    <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",color:C.cream,fontSize:17,lineHeight:1.85,margin:"0 0 12px",opacity:0.9}}>"I have shown you only a glimpse of your future... The full truth is far more revealing... If you wish to uncover what truly awaits you, you must allow me to complete the reading."</p>
                    <p style={{fontFamily:"Crimson Text,serif",fontStyle:"italic",color:C.muted,fontSize:15,lineHeight:1.6,margin:"0 0 10px"}}>Full palm analysis · Past life echo · Complete mystical narrative · Fate line reading</p>
                    <div style={{display:"flex",gap:8,alignItems:"center",justifyContent:"center",margin:"10px 0"}}>
                      <span style={{fontFamily:"Cinzel,serif",fontSize:14,color:C.muted,textDecoration:"line-through"}}>$9.99</span>
                      <span style={{fontFamily:"Cinzel,serif",fontSize:28,color:C.gold,fontWeight:700}}>$2.99</span>
                      <span style={{background:C.roseDim,color:C.rose,borderRadius:20,padding:"2px 9px",fontFamily:"Cinzel,serif",fontSize:11}}>70% OFF</span>
                    </div>
                    <button className="gold-btn" onClick={()=>setPaid(true)} style={{width:"100%",padding:"12px",fontSize:16,borderRadius:11,marginBottom:6}}>🔮 Unlock Full Reading — $2.99</button>
                    <button className="rose-btn" onClick={()=>setSubscribed(true)} style={{width:"100%",padding:"10px",fontSize:15,borderRadius:11,marginBottom:6}}>🌙 Subscribe — $6.99/mo · Unlimited</button>
                    <p style={{fontFamily:"Crimson Text,serif",fontSize:14,color:C.muted,margin:0}}>Instant access · Secure · Cancel anytime</p>
                  </div>
                )}
                {(paid||subscribed)&&(
                  <div style={{animation:"fadeUp 0.6s ease both"}}>
                    <div style={{background:C.surface,border:`1px solid ${C.gold}2a`,borderRadius:14,padding:"16px",marginBottom:10}}>
                      ...
                      <div style={{fontFamily:"Cinzel,serif",fontSize:15,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:12,textAlign:"center"}}>✦ The Full Reading ✦</div>
                      {reading.pastLife&&(
                        <div style={{background:"rgba(50,15,70,0.3)",border:`1px solid rgba(110,35,130,0.3)`,borderRadius:9,padding:"10px 11px",marginBottom:12}}>
                          <div style={{fontFamily:"Cinzel,serif",fontSize:13,color:"#b070d8",letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>🌀 Past Life Echo</div>
                          <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:19,color:C.cream,margin:0,lineHeight:1.8}}>{reading.pastLife}</p>
                        </div>
                      )}
                      ...
                      <Divider/>
                      <div style={{fontFamily:"Cinzel,serif",fontSize:13,color:C.goldDim,letterSpacing:3,textTransform:"uppercase",marginBottom:10,textAlign:"center"}}>✦ Madame Seraphina Speaks ✦</div>
                ...
                {!paid&&!subscribed&&(
                  <button className="ghost-btn" onClick={()=>setPaid(true)} style={{width:"100%",padding:"9px",fontSize:14,borderRadius:9,marginBottom:7}}>👁 Preview Full Reading (Demo)</button>
                )}
              </div>
            )}
              ...
              <div style={{animation:"fadeIn 0.3s ease both"}}>
                ...
                <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px",marginBottom:10}}>
                  ...
                  {(()=>{
                    ...
                    return <p style={{fontFamily:"IM Fell English,serif",fontStyle:"italic",fontSize:19,color:C.cream,margin:"0 0 8px",lineHeight:1.85}}>{`"${todayFortune}"`}</p>;
                  })()}
                </div>
            ...
            <button className="ghost-btn" onClick={()=>{setPhase("intro");setReading(null);setPalmImage(null);setPaid(false);setSubscribed(false);setActiveTab("reading");setSpeaking(false);}}
              style={{width:"100%",padding:"9px",fontSize:14,borderRadius:9}}>
              🔄 Begin a New Reading
            </button>
          </div>
        )}

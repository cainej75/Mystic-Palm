...
.return-btn:hover { background: #b0405a; color: #fff; }
.print-btn {
  background: var(--gold); color: #080510; border: none;
  padding: 10px 22px; font-family: 'Cinzel', serif; font-size: 13px;
...
/* ── Page 2 top padding ── */
.page2-pad { display: none; height: 32px; }
...
<div class="top-bar">
  <button class="return-btn" onclick="window.close()">← Return to Reading</button>

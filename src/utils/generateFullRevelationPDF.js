...
/* ── Continued marker — screen: hidden, print: shown near top of page 2 ── */
.continued {
  display: none;
  text-align: center;
  padding-top: 28px;
...
.continued-text {
  font-family: 'IM Fell English', serif; font-style: italic;
  font-size: 17px; color: var(--gold); letter-spacing: 2px;
}
...
.footer-brand {
  font-family: 'Cinzel', serif; font-size: 10px; color: rgba(201,168,76,0.55);
...
<div class="page">
  <div class="page-inner">
    ...
    <!-- Continued marker — sits here so it appears near the top of page 2 -->
    <div class="continued">

    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:700,margin:"0 auto",padding:"40px 20px 60px",position:"relative",zIndex:2}}>
        ...
        <div style={{textAlign:"center",marginTop:40}}>
          <button onClick={() => navigate(-1)} style={{fontFamily:"Cinzel,serif",fontSize:12,color:C.gold,letterSpacing:1,textDecoration:"none",background:"none",border:"none",cursor:"pointer",padding:0}}>← Back</button>
        </div>
      </div>
    </div>
  );

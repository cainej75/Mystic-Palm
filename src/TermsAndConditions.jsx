    ...
    <div style={{minHeight:"100vh",background:C.bg,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{maxWidth:700,margin:"0 auto",padding:"40px 20px 60px",position:"relative",zIndex:2}}>
        ...
        <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:30}}>
          ...
          <section style={{marginBottom:30}}>
            <h2 style={{fontFamily:"Cinzel,serif",fontSize:20,color:C.gold,marginBottom:12}}>11. Refund Policy</h2>
            <p style={{fontFamily:"Crimson Text,serif",fontSize:16,color:C.cream,lineHeight:1.8,margin:0}}>
              <strong style={{color:C.gold}}>All payments are final and non-refundable.</strong> Due to the immediate digital nature of our products — which are delivered and accessible at the moment of purchase — we are unable to offer refunds under any circumstances. By completing a purchase, you acknowledge and agree that no refunds will be issued.
            </p>
          </section>

          <section style={{marginBottom:0}}>
            <h2 style={{fontFamily:"Cinzel,serif",fontSize:20,color:C.gold,marginBottom:12}}>12. Contact Us</h2>
            <p style={{fontFamily:"Crimson Text,serif",fontSize:16,color:C.cream,lineHeight:1.8,margin:0}}>

...
const InAppBrowserLandingPage = ({ browserInfo }) => {
  ...
  const handleOpenReading = () => {
    // Attempt to reload in current context
    // User will need to manually open in browser via the instructions
      ...
      >
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.target.style.boxShadow = '0 12px 32px rgba(201,168,76,0.5)';
          }}
          onMouseLeave={(e) => {
            e.target.style.transform = 'translateY(0)';
            e.target.style.boxShadow = '0 8px 24px rgba(201,168,76,0.3)';
          }}
        >
          ✨ Open My Reading
        </button>

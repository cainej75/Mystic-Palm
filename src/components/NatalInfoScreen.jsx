      ...
      <div style={{
        ...
        <div style={{textAlign:"center", marginBottom:20, marginTop:16}}>
          ...
          <p style={{
            ...
            Your birth city and time let Madame Zafira read far deeper. Share them for a more precise reading.
          </p>
        </div>
        ...
        <div style={{marginBottom:18}}>
          ...
          {localUnknown && (
            <p style={{
              ...
              Your rising sign will remain unread — but what the palm reveals will still be significant.
            </p>
          )}
        </div>

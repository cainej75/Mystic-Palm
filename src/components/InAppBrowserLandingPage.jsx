...
// Detect which app user came from
const detectAppBrowser = () => {
...
export const InAppBrowserLandingPage = () => {
  const [appName, setAppName] = useState('');
  const [copied, setCopied] = useState(false);

  useEffect(() => {
    setAppName(detectAppBrowser());
  }, []);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ✨ Thousands have already unlocked their reading today...
          </p>
        </div>
...
export default InAppBrowserLandingPage;
